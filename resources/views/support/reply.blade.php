...
@section('action-btn')
    <div class="float-end">
        <a href="#" data-size="lg" data-url="{{ route('support.edit', $support->id) }}" data-ajax-popup="true"
            data-bs-toggle="tooltip" title="{{ __('Edit') }}" data-title="{{ __('Edit Support') }}"
                        ...
                        <div class="row">
                            <div class="card">
                                <div class="card-body">
                                    <div class="row ">
                                        ...
                                        @if ($plan->chatgpt == 1)
                                            <div class="col-6 text-end">
                                                <a href="#" data-size="md"
                                                    class="btn btn-primary btn-icon btn-sm mb-3 me-2"
                                    ...
                                    <form action="{{ route('support.reply.answer', $support->id) }}" method="POST">
                                        @csrf
                                        ...
                                        <div class="text-end">
                                            <div class="col-12">
                                                <button type="submit" class="btn btn-primary w-100">
                                                    <i class="ti ti-circle-plus me-1 mb-0"></i> {{ __('Send') }}
                                                </button>
                                            </div>
                                        </div>
                                    </form>
                            ...
                            <div class="card-header row d-flex align-items-center justify-content-between">
                                <div class="header-right col d-flex align-items-start">
                                    ...
                                    <h6 class="mb-0">{{ !empty($reply->users) ? $reply->users->name : '' }}
                                        <div class="d-block text-muted">{{ !empty($reply->users) ? $reply->users->email : '' }}
                                        </div>
                                    </h6>
                                </div>
