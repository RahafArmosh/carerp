                                            ...
                                            @can('delete client')
                                                <form action="{{ route('clients.destroy', $client['id']) }}" method="POST"
                                                    ...
                                                    <a href="#!" class="dropdown-item bs-pass-para"
                                                        onclick="confirmAction('{{ __('Are You Sure?') . '|' . __('This action can not be undone. Do you want to continue?') }}', '{{ $client->delete_status }}', 'delete-form-{{ $client['id'] }}')">
                                    ...
                                    <div class="col-6">
                                        <h6 class="mb-0">
                                            @if ($client->clientDeals)
                                                <a href="{{ route('client.deals', ['id' => $client->id]) }}" title="View client deals">
