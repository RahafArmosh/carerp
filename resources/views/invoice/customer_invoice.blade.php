...
<html lang="en" dir="{{ $settings_data['SITE_RTL'] == 'on' ? 'rtl' : '' }}">
    ...
    <head>
        ...
        <title>
            {{ Utility::companyData($invoice->created_by, 'title_text') ? Utility::companyData($invoice->created_by, 'title_text') : config('app.name', 'Orbix') }}
            - {{ __('Invoice') }}</title>
                                    ...
                                    <div class="row invoice-title mt-2">
                                        ...
                                        <div class="col-xs-12 col-sm-12 col-nd-6 col-lg-6 col-12 text-end">
                                            <h3 class="invoice-number float-right">
                                                ...
                                                {{ $user->invoiceNumberFormat($id) }}</h3>
                                        </div>
                                        <div class="col-12">
                                            <hr>
                                        </div>
                                                ...
                                                <table class="table mb-0 table-striped">
                                                    ...
                                                    @foreach ($iteams as $key => $iteam)
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td>
                                                                @if (!empty($iteam->tax) && \App\Models\ProductService::where('id', $iteam->product_id)->first()->type === 'product')
                                                                    <table>
                                                                        @php
                                                                            $itemTaxes = [];
                                                            ...
                                                            @else
                                                                <td class="text-end">
                                                                    {{ Utility::priceFormat($settings, $iteam->price * $iteam->quantity - $iteam->discount) }}
                                                                </td>
                                                            @endif
                                                    ...
                                                    <tfoot>
                                                        ...
                                                        @if ($invoice->type == 'rent')
                                                            <tr>
                                                                <td colspan="6"></td>
                                                                <td class="text-end"><b>{{ __('Dayes of Rent') }}</b>
                                                                </td>
                                                                <td class="text-end">
                                                                    {{ $invoice->getDaysDifferenceAttribute() }}
                                                                </td>
                                                            </tr>
                                                        @endif
                                                        <tr>
                                                ...
                                                @can('delete invoice product')
                                                    <td>
                                                        ...
                                                        <div class="action-btn bg-danger ms-2">
                                                            <form method="POST"
                                                                action="{{ route('invoice.payment.destroy', ['invoice' => $invoice->id, 'payment' => $bankPayment->id]) }}"
                                                ...
                                                @if (isset($company_payment_setting['is_benefit_enabled']) && $company_payment_setting['is_benefit_enabled'] == 'on')
                                                    <li class="nav-item mb-2">
                                                        <a class="btn btn-outline-primary btn-sm me-1 ml-1"
                                                            ...
                                                            role="tab" aria-controls="benefit"
