                                ...
                                <table class="no-space" style="width: 70%;">
                                    <tbody>
                                        <tr>
                                            <td>{{ __('Number') }}:</td>
                                            <td class="text-right">
                                                {{ Utility::invoiceNumberFormat($settings, $invoice->id) }}</td>
                                        </tr>
                                        <tr>
                                            <td>{{ __('Issue Date') }}:</td>
                                            <td class="text-right">
                                        ...
                                        <tr>
                                            <td colspan="2">
                                                <div class="view-qrcode" style="margin-top: 0;">
                                                    {!! DNS2D::getBarcodeHTML(route('invoice.link.copy', \Crypt::encrypt($invoice->id)), 'QRCODE', 2, 2) !!}
                                                </div>
                                            </td>
                                        </tr>
                                    </tbody>
                        ...
                        @if (isset($invoice->itemData) && count($invoice->itemData) > 0)
                            @foreach ($invoice->itemData as $key => $item)
                                <tr>
                                    ...
                                    @endphp
                                    <td>{{ $item->quantity . ' (' . !empty($unitName) ? $unitName->name : '' . ')' }}
                                    </td>
                            ...
                            <td colspan="2" class="sub-total">
                                <table class="total-table">
                                    ...
                                    <tr>
                                        ...
                                        <td>{{ Utility::priceFormat($settings, $invoice->invoiceTotalCreditNote()) }}
                                        </td>
                                    </tr>
                                    <tr>
                                        <td>{{ __('Due Amount') }}:</td>
