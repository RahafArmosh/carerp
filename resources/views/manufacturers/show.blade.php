...
@section('breadcrumb')
    ...
    <li class="breadcrumb-item"><a href="{{route('manufacturers.index')}}">{{__('Manufacturers')}}</a></li>
                            ...
                            <div class="row">
                                ...
                                <div class="col">
                                    <small>
                                        ...
                                        {{\Auth::user()->dateFormat($expense->date)}}<br><br>
                                    </small>
