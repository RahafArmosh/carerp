                                                ...
                                                @can('delete budget plan')
                                                    <div class="action-btn bg-danger ms-2">
                                                        <form action="{{ route('budget.destroy', $budget->id) }}"
                                                            method="POST" id="delete-form-{{ $budget->id }}">
                                                            @csrf
                                                            @method('DELETE')
                                                            <a href="#"
                                                                ...
                                                                onclick="confirmDelete('{{ __('Are You Sure?') . '|' . __('This action can not be undone. Do you want to continue?') }}', 'delete-form-{{ $budget->id }}')">
