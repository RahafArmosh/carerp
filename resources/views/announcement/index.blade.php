...
@section('action-btn')
    <div class="float-end">
        @can('create announcement')
            <a href="#" data-url="{{ route('announcement.create') }}" data-size="lg" data-ajax-popup="true"
                data-title="{{ __('Create New Announcement') }}" data-bs-toggle="tooltip" title="{{ __('Create') }}"
                                                ...
                                                @can('edit announcement')
                                                    <div class="action-btn bg-primary ms-2">
                                                        ...
                                                        <a href="#"
                                                            ...
                                                            class="x-3 btn btn-sm align-items-center" data-bs-toggle="tooltip"
                                                            title="{{ __('Edit') }}"
                                                    ...
                                                    <div class="action-btn bg-danger ms-2">
                                                        <form action="{{ route('announcement.destroy', $announcement->id) }}"
                                                            ...
                                                            <a href="#"
                                                                ...
                                                                onclick="confirmDelete('{{ __('Are You Sure?') . '|' . __('This action can not be undone. Do you want to continue?') }}', 'delete-form-{{ $announcement->id }}')">
