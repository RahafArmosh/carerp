                                            ...
                                            <td class="text-end">
                                                ...
                                                <div class="action-btn bg-primary ms-2">
                                                    <a href="#"
                                                        ...
                                                        title="{{ __('Click to copy iframe link') }}"><i
                                                ...
                                                <div class="action-btn bg-primary ms-2">
                                                    <a href="#"
                                                        ...
                                                        data-bs-toggle="tooltip" title="{{ __('Click to copy link') }}"><i
                                                ...
                                                @can('delete form builder')
                                                    <div class="action-btn bg-danger ms-2">
                                                        <form id="delete-form-{{ $form->id }}"
                                                            action="{{ route('form_builder.destroy', $form->id) }}"
                                                            method="POST">
                                                            @csrf
                                                            @method('DELETE')
                                                            <a href="#"
                                                                ...
                                                                onclick="confirmDelete('{{ __('Are You Sure?') }}', event, 'delete-form-{{ $form->id }}')">
