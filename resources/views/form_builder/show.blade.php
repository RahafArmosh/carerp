...
@section('action-btn')
    @can('create form field')
        <div class="float-end">
            <a href="#" data-size="md" data-url="{{ route('form.field.create', $formBuilder->id) }}" data-ajax-popup="true"
                data-bs-toggle="tooltip" title="{{ __('Create New Filed') }}" class="btn btn-sm btn-primary">
                                            ...
                                            <td class="text-end">
                                                ...
                                                @can('delete form builder')
                                                    <div class="action-btn bg-danger ms-2">
                                                        <form
                                                            action="{{ route('form.field.destroy', [$formBuilder->id, $field->id]) }}"
                                                            method="POST">
                                                            @csrf
                                                            @method('DELETE')
                                                            <a href="#"
                                                                ...
                                                                onclick="confirmDelete('{{ __('Are You Sure?') }}', this.parentNode)">
