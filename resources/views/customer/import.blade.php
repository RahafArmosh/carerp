...
<div class="modal-body">
    <div class="row">
        <div class="col-md-12 mb-6">
            <label for="file" class="form-label">{{ __('Download sample customer CSV file') }}</label>
            <a href="{{asset('uploads/sample/sample-customer.csv')}}" class="btn btn-sm btn-primary">
