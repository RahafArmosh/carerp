...
@section('content')
    ...
    <ul class="nav nav-pills my-3" id="pills-tab" role="tablist">
        <li class="nav-item">
            <a class="nav-link" id="pills-home-tab" data-bs-toggle="pill" href="{{ route('report.monthly.cashflow') }}"
    ...
    <div class="row">
        <div class="col-sm-12">
            <div class=" mt-2 " id="multiCollapseExample1">
                <div class="card">
                    <div class="card-body">
                        <form action="{{ route('report.quarterly.cashflow') }}" method="GET" id="quarterly_cashflow">
                            @csrf
                                        ...
                                        <div class="col-xl-3 col-lg-3 col-md-6 col-sm-12 col-12">
                                            <div class="btn-box">
                                                ...
                                                <select name="year" id="year" class="form-control select">
                                                    @foreach ($yearList as $yearItem => $yearLabel)
                                                        <option value="{{ $yearItem }}"
                                                            {{ isset($_GET['year']) && $_GET['year'] == $yearItem ? 'selected' : '' }}>
                                                            {{ $yearLabel }}
                                                        </option>
                                                    @endforeach
                                                </select>
                                    ...
                                    <div class="row">
                                        <div class="col-auto mt-4">
                                            <a href="#" class="btn btn-sm btn-primary"
                                                onclick="document.getElementById('quarterly_cashflow').submit(); return false;"
                                            ...
                                            <div class="col-sm-12">
                                                <table class="table table-flush border">
                                                    <tbody>
                                                        ...
                                                        <tr>
                                                            <td width="25%" class="text-dark">{{ __('Net Profit') }}
                                                            </td>
