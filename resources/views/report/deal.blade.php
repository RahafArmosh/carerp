                ...
                <div class="col-xl-9">
                    <div id="general-report">
                        ...
                        <div class="card">
                            ...
                            <div class="card-body pt-0">
                                <div class="deals-sources-report" id="deals-sources-report" data-color="primary"
                                    data-height="280">
                                </div>
                            </div>
                        </div>
                    ...
                    <div id="staff-report" class="card">
                        ...
                        <div class="card-body">
                            ...
                            <div id="deals-staff-report" class="mt-3" data-color="primary" data-height="280">
                            </div>
                        </div>
                    </div>
                    <div id="pipeline-report" class="card">
                        ...
                        <div class="card-body">
                            <div class="row">
                                <div id="deals-piplines-report" data-color="primary" data-height="280"></div>
                            </div>
                        </div>
                    </div>
