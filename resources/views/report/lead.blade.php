                    ...
                    <div class="card sticky-top" style="top:30px">
                        <div class="list-group list-group-flush" id="useradd-sidenav">
                            <a href="#general-report"
                                class="list-group-item list-group-item-action border-0">{{ __('General Report') }}
                                <div class="float-end"><i class="ti ti-chevron-right"></i></div>
                            </a>
                            <a href="#staff-report"
                                class="list-group-item list-group-item-action border-0">{{ __('Staff Report') }}
                                <div class="float-end"><i class="ti ti-chevron-right"></i></div>
                            </a>
                            <a href="#pipeline-report"
                                class="list-group-item list-group-item-action border-0">{{ __('Pipelines Report') }}
                                <div class="float-end"><i class="ti ti-chevron-right"></i></div>
                            </a>
                        </div>
                    </div>
                ...
                <div class="col-xl-9">
                    <div id="general-report">
                        <div class="card">
                            ...
                            <div class="card-body pt-0 ">
                                <div id="leads-this-week" data-color="primary" data-height="280">
                                </div>
                            </div>
                        </div>
                        <div class="card">
                            ...
                            <div class="card-body pt-0">
                                <div class="leads-sources-report" id="leads-sources-report" data-color="primary"
                                    data-height="280">
                                </div>
                            </div>
                        </div>
                            ...
                            <div class="card-header">
                                <div class="row">
                                    ...
                                    <div class="col-3 float-right">
                                        <select name="month" class="form-control selectpicker" id="selectmonth"
                    ...
                    <div id="staff-report" class="card">
                        ...
                        <div class="card-body">
                            <div class="row">
                                <div class="col-md-4">
                                    <label for="from_date" class="col-form-label">{{ __('From Date') }}</label>
                                    <input type="date" id="from_date" name="from_date" class="form-control from_date" />
                                    <span id="fromDate" style="color: red;"></span>
                                </div>
                                <div class="col-md-4">
                                    <label for="to_date" class="col-form-label">{{ __('To Date') }}</label>
                                    <input type="date" id="to_date" name="to_date" class="form-control to_date" />
                            ...
                            <div id="leads-staff-report" class="mt-3" data-color="primary" data-height="280">
                            </div>
                        </div>
                    </div>
...
@push('script-page')
    ...
    <script>
        $(".generate_button").click(function() {
            ...
            // Prevent AJAX if either date is empty
            ...
            $.ajax({
                ...
                success: function(data) {
                    ...
                    var arChart = new ApexCharts(document.querySelector("#leads-staff-report"),
                        chartBarOptions);
                    arChart.render();
            ...
            $("#selectmonth").change(function() {
                ...
                $.ajax({
                    ...
                    success: function(data) {
                        ...
                        var arChart = new ApexCharts(document.querySelector("#leads-monthly"),
                            chartBarOptions);
                        arChart.render();
