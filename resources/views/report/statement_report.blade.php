    ...
    <div class="row">
        <div class="col-sm-12">
            <div class="mt-2 " id="multiCollapseExample1">
                <div class="card">
                    <div class="card-body">
                        <form action="{{ route('report.account.statement') }}" method="GET" id="report_account">
                            <div class="row align-items-center justify-content-end">
                                <div class="col-xl-10">
                                    <div class="row">
                                                ...
                                                <select name="account" id="account" class="form-control select">
                                                    @foreach ($account as $accountId => $accountLabel)
                                                        <option value="{{ $accountId }}"
                                                            @if (isset($_GET['account']) && $_GET['account'] == $accountId) selected @endif>
                                                            {{ $accountLabel }}</option>
                                                    @endforeach
                                                </select>
                                            </div>
                                        ...
                                        <div class="col-xl-3 col-lg-3 col-md-6 col-sm-12 col-12">
                                            <div class="btn-box">
                                                <label for="type" class="form-label">{{ __('Category') }}</label>
                                                <select name="type" id="type" class="form-control select"
                                                    placeholder="{{ __('Select Category') }}">
                                                    @foreach ($types as $typeId => $typeLabel)
                                                        <option value="{{ $typeId }}"
                                                            @if (isset($_GET['type']) && $_GET['type'] == $typeId) selected @endif>
                                                            {{ $typeLabel }}</option>
                                                    @endforeach
                                                </select>
                                            </div>
