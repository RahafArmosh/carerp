    ...
    <div class="row">
        <div class="col-sm-12">
            <div class="mt-2 " id="multiCollapseExample1">
                <div class="card">
                    <div class="card-body">
                        <form action="{{ route('report.bill.summary') }}" method="GET" id="report_bill_summary">
                                        ...
                                        <div class="col-xl-3 col-lg-3 col-md-6 col-sm-12 col-12">
                                            <div class="btn-box">
                                                ...
                                                <select name="vendor" id="vendor" class="form-control select">
                                                    @foreach ($vender as $venderOption)
                                                        <option value="{{ $venderOption }}"
                                                            {{ isset($_GET['vender']) && $_GET['vender'] == $venderOption ? 'selected' : '' }}>
                                                            {{ $venderOption }}
                                                        </option>
                                                    @endforeach
                                                </select>
                                        ...
                                        <div class="col-xl-3 col-lg-3 col-md-6 col-sm-12 col-12">
                                            <div class="btn-box">
                                                ...
                                                <select name="status" id="status" class="form-control select">
                                                    ...
                                                    @foreach ($status as $index => $statusOption)
                                                        @if(trim($statusOption) != '')
                                                            <option value="{{ $index }}"
                                                                {{ isset($_GET['status']) && $_GET['status'] == $index ? 'selected' : '' }}>
                                                                {{ $statusOption }}
                                                            </option>
                                                        @endif
                                                    @endforeach
                        ...
                        <div class="card-header">
                            <div class="d-flex justify-content-between w-100">
                                ...
                                <ul class="nav nav-pills mb-3" id="pills-tab" role="tablist">
                                    <li class="nav-item">
                                        <a class="nav-link active" id="profile-tab3" data-bs-toggle="pill"
