    ...
    <div class="row">
        <div class="col-sm-12">
            <div class="mt-2 " id="multiCollapseExample1">
                <div class="card">
                    <div class="card-body">
                        <form action="{{ route('report.expense.summary') }}" method="GET" id="report_expense_summary">
                                        ...
                                        <div class="col-xl-3 col-lg-3 col-md-6 col-sm-12 col-12">
                                            <div class="btn-box">
                                                ...
                                                <select name="year" id="year" class="form-control select">
                                                    @foreach ($yearList as $year => $label)
                                                        <option value="{{ $year }}"
                                        ...
                                        <div class="col-xl-3 col-lg-3 col-md-6 col-sm-12 col-12">
                                            <div class="btn-box">
                                                ...
                                                <select name="category" id="category" class="form-control select">
                                                    @foreach ($category as $categoryId => $categoryLabel)
                                                        <option value="{{ $categoryId }}"
                                                            @if (isset($_GET['category']) && $_GET['category'] == $categoryId) selected @endif>
                                        ...
                                        <div class="col-xl-3 col-lg-3 col-md-6 col-sm-12 col-12">
                                            <div class="btn-box">
                                                ...
                                                <select name="vendor" id="vendor" class="form-control select">
                                                    @foreach ($vender as $vendorId => $vendorLabel)
                                                        <option value="{{ $vendorId }}"
                                                            @if (isset($_GET['vendor']) && $_GET['vendor'] == $vendorId) selected @endif>
                                                            {{ $vendorLabel }}</option>
                                                    @endforeach
                                                </select>
                                            </div>
