    ...
    <div class="row">
        <div class="col-sm-12">
            <div class=" mt-2 " id="multiCollapseExample1">
                <div class="card">
                    <div class="card-body">
                        <form action="{{ route('report.leave') }}" method="GET" id="report_leave">
                                        ...
                                        <div class="col-xl-3 col-lg-3 col-md-6 col-sm-12 col-12 year d-none">
                                            <div class="btn-box">
                                                ...
                                                <select id="year" name="year" class="form-control select"
                                                    ...
                                                    @for ($year = $filterYear['starting_year']; $year <= $filterYear['ending_year']; $year++)
                                                        <option
                                                            {{ isset($_GET['year']) && $_GET['year'] == $year ? 'selected' : '' }}
                                                            {{ !isset($_GET['year']) && date('Y') == $year ? 'selected' : '' }}
                                            ...
                                            <div class="btn-box">
                                                ...
                                                <select name="branch" id="branch" class="form-control select">
                                                    @foreach ($branch as $branchOption)
                                                        <option value="{{ $branchOption }}"
                                                            {{ isset($_GET['branch']) && $_GET['branch'] == $branchOption ? 'selected' : '' }}>
                                                            {{ $branchOption }}
                                                        </option>
                                                    @endforeach
                                                </select>
                                        ...
                                        <div class="col-xl-3 col-lg-3 col-md-6 col-sm-12 col-12">
                                            <div class="btn-box">
                                                ...
                                                <select name="department" id="department" class="form-control select">
                                                    @foreach ($department as $departmentOption)
                                                        <option value="{{ $departmentOption }}"
                                                            {{ isset($_GET['department']) && $_GET['department'] == $departmentOption ? 'selected' : '' }}>
                                                            {{ $departmentOption }}
                                                        </option>
                                                    @endforeach
                                                </select>
                                ...
                                <table class="table mb-0" id="report-dataTable">
                                    ...
                                    <tbody>
                                        @foreach ($leaves as $leave)
                                            <tr>
                                                <td><a href="#"
                                                        class="btn btn-sm btn-primary">{{ \Auth::user()->employeeIdFormat($leave['employee_id']) }}</a>
                                                </td>
