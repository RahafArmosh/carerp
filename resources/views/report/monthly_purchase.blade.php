...
@section('content')
    ...
    <div class="row">
        <div class="col-sm-12">
            <div class="mt-2 ">
                <div class="card">
                    <div class="card-body">
                        <form action="{{ route('report.monthly.purchase') }}" method="GET"
                                ...
                                <div class="col-xl-3 col-lg-3 col-md-6 col-sm-12 col-12 mr-2">
                                    <div class="btn-box">
                                        ...
                                        <select name="warehouse" id="warehouse" class="form-control select">
                                            @foreach ($warehouse as $warehouseId => $warehouseName)
                                                <option value="{{ $warehouseId }}"
                                                    {{ isset($_GET['warehouse']) && $_GET['warehouse'] == $warehouseId ? 'selected' : '' }}>
                                                    {{ $warehouseName }}
                                                </option>
                                            @endforeach
                                        </select>
                                ...
                                <div class="col-xl-3 col-lg-3 col-md-6 col-sm-12 col-12 mr-2">
                                    <div class="btn-box">
                                        ...
                                        <select name="vendor" id="vendor" class="form-control select">
                                            @foreach ($vendor as $vendorId => $vendorName)
    ...
    <div id="printableArea">
        <div class="row mt-0">
            <div class="col">
                <input type="hidden"
                    value="{{ $filter['warehouse'] . ' ' . __('Monthly Purchase') . ' ' . 'Report of' . ' ' . $filter['startMonth'] . ' to ' . $filter['endMonth'] }}"
                    id="filename">
