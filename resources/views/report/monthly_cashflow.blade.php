...
@section('content')
    ...
    <ul class="nav nav-pills my-3" id="pills-tab" role="tablist">
        ...
        <li class="nav-item">
            <a class="nav-link" id="pills-profile-tab" data-bs-toggle="pill" href="{{ route('report.quarterly.cashflow') }}"
    ...
    <div class="row">
        <div class="col-sm-12">
            <div class=" mt-2 "id="multiCollapseExample1">
                <div class="card">
                    <div class="card-body">
                        <form action="{{ route('report.monthly.cashflow') }}" method="GET" id="monthly_cashflow">
                                        ...
                                        <div class="col-xl-3 col-lg-3 col-md-6 col-sm-12 col-12">
                                            <div class="btn-box">
                                                ...
                                                <select name="year" id="year" class="form-control select">
                                                    @foreach ($yearList as $yearOption)
                                ...
                                <div class="col-auto">
                                    <div class="row">
                                        <div class="col-auto mt-4">
                                            ...
                                            <a href="{{ route('report.monthly.cashflow') }}" class="btn btn-sm btn-danger"
                                    ...
                                    <div class="table-responsive mt-3 mb-3">
                                        <table class="table">
                                            ...
                                            <tbody>
                                                ...
                                                <tr>
                                                    <td colspan="13" class="font-bold">
                                                        <span>{{ __('Total Income =  Revenue + Invoice ') }}</span></td>
                                                </tr>
                                                <tr>
                                        ...
                                        <div class="table-responsive mt-4">
                                            <table class="table mb-0">
                                                ...
                                                <tbody>
                                                    ...
                                                    <tr>
                                                        <td colspan="13" class="font-bold">
                                                            <span>{{ __('Total Expense =  Payment + Bill ') }}</span></td>
                                                    </tr>
                                                    <tr>
                                                        <td width="20%" class="text-dark">{{ __('Total Expenses') }}
                                                        </td>
