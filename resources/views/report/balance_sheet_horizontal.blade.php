...
@section('action-btn')
    ...
    <div class="float-end me-2">
        <form action="{{ route('balance.sheet.export') }}" method="POST">
            @csrf
            ...
            <div class="col-md-12">
                <div class="mt-2" id="multiCollapseExample1">
                    <div class="card" id="show_filter" style="display:none;">
                        <div class="card-body">
                            <form action="{{ route('report.balance.sheet') }}" method="GET" id="report_bill_summary">
                                <div class="row align-items-center justify-content-end">
                                    <div class="col-xl-10">
                                        <div class="row">
                                            <div class="col-xl-3 col-lg-3 col-md-6 col-sm-12 col-12">
                                                <div class="btn-box">
                                                    <!-- Add any content or elements here -->
                                                </div>
                                            </div>
                                            <div class="col-xl-3 col-lg-3 col-md-6 col-sm-12 col-12">
                                                <div class="btn-box">
                                    ...
                                    <div class="border-start border-end">
                                                ...
                                                <div class="account-main-inner py-2">
                                                    ...
                                                    @if ($type == 'Liabilities')
                                                        <div
                                                            ...
                                                            <h6 class="fw-bold mb-0 text-end me-3 {{ $profitLoss >= 0 ? 'text-success' : 'text-danger' }}">
                                                                {{ \Auth::user()->priceFormat($profitLoss) }}
                                                            </h6>
                                                        </div>
                                                        @php
                                        ...
                                        @if ($totalAmount != 0)
                                            <div
                                                ...
                                                <h6 class="fw-bold mb-0 ms-2">{{ 'Total for Liabilities and Profit/Loss for the Period' }}</h6>
                                                <h6 class="fw-bold mb-0 text-end me-3">
