    ...
    <div class="row">
        <div class="col-sm-12">
            <div class="mt-2 ">
                <div class="card">
                    <div class="card-body">
                        <form action="{{ route('report.daily.purchase') }}" method="GET"
                                ...
                                <div class="col-xl-3 col-lg-3 col-md-6 col-sm-12 col-12 mr-2">
                                    <div class="btn-box">
                                        ...
                                        <select name="vendor" id="vendor" class="form-control select">
                                            @foreach ($vendor as $vendorOption)
                                                <option value="{{ $vendorOption }}"
                                                    {{ isset($_GET['vendor']) && $_GET['vendor'] == $vendorOption ? 'selected' : '' }}>
                                                    {{ $vendorOption }}
                                                </option>
                                            @endforeach
                                        </select>
