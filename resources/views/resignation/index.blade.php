    ...
    <div class="float-end">
        @can('create resignation')
            <a href="#" data-size="lg" data-url="{{ route('resignation.create') }}" data-ajax-popup="true"
                data-bs-toggle="tooltip" title="{{ __('Create') }}" data-title="{{ __('Create New Resignation') }}"
                                            ...
                                            <td>
                                                ...
                                                @can('edit resignation')
                                                    <div class="action-btn bg-primary ms-2">
                                                        <a href="#" class="mx-3 btn btn-sm align-items-center"
                                                            ...
                                                            data-ajax-popup="true" data-title="{{ __('Edit Resignation') }}"
                                                ...
                                                @can('delete resignation')
                                                    <div class="action-btn bg-danger ms-2">
                                                        <form method="POST"
                                                            action="{{ route('resignation.destroy', $resignation->id) }}"
