    ...
    <div class="row">
        <div class="col-sm-12">
            <div class=" " id="multiCollapseExample1">
                <div class="card">
                    <div class="card-body">
                        <form action="{{ route('attendanceemployee.bulkattendance') }}" method="get"
                                        ...
                                        <div class="col-xl-3 col-lg-3 col-md-6 col-sm-12 col-12">
                                            <div class="btn-box">
                                                ...
                                                <select name="branch" id="branch" class="form-control select" required>
                                                    ...
                                                    @foreach ($branch as $id => $branch_name)
                                                        <option value="{{ $id }}"
                                                            {{ isset($_GET['branch']) && $_GET['branch'] == $id ? 'selected' : '' }}>
                                                            {{ $branch_name }}</option>
                                                    @endforeach
                                                </select>
                                            </div>
                                            ...
                                            <div class="btn-box">
                                                ...
                                                <select name="department" id="department" class="form-control select"
                                                    ...
                                                    @foreach ($department as $id => $department_name)
                                                        <option value="{{ $id }}"
                                                            {{ isset($_GET['department']) && $_GET['department'] == $id ? 'selected' : '' }}>
                        ...
                        <form action="{{ route('attendanceemployee.bulkattendance.store') }}" method="post">
                                    ...
                                    <tbody>
                                        @foreach ($employees as $employee)
                                            ...
                                            <tr>
                                                ...
                                                <td>{{ !empty($employee->department) ? $employee->department->name : '' }}
                                                </td>
                                                <td>
                                                    ...
                                                    <div class="row">
                                                        ...
                                                        <div
                                                            ...
                                                            <div class="row">
                                                                <label
                                                                    class="col-md-2 form-label mt-2">{{ __('In') }}</label>
                                                                <div class="col-md-4">
                            ...
                            <div class="attendance-btn float-end pt-4">
                                <input type="hidden" value="{{ isset($_GET['date']) ? $_GET['date'] : date('Y-m-d') }}"
                                    name="date">
                                <input type="hidden" value="{{ isset($_GET['branch']) ? $_GET['branch'] : '' }}"
                                    name="branch">
