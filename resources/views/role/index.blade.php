                                                            ...
                                                            <div class="action-btn bg-danger ms-2">
                                                                <form method="POST"
                                                                    ...
                                                                    <a href="#"
                                                                        ...
                                                                        onclick="event.preventDefault(); if (confirm('{{ __('Are You Sure?') . ' | ' . __('This action can not be undone. Do you want to continue?') }}')) { document.getElementById('delete-form-{{ $role->id }}').submit(); }">
