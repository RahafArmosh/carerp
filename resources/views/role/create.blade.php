                                                                ...
                                                                @if ($key = array_search('view ' . $module, $permissions))
                                                                    <div
                                                                        ...
                                                                        <input type="checkbox" name="permissions[]"
                                                                            value="{{ $key }}"
                                                                            class="form-check-input isscheck staff_checkall isscheck_{{ str_replace(' ', '', str_replace('&', '', $module)) }}"
                                                                            id="permission{{ $key }}">
                                                            ...
                                                            @if (in_array('view ' . $module, (array) $permissions))
                                                                @if ($key = array_search('view ' . $module, $permissions))
                                                                    <div
                                                                        ...
                                                                        <input type="checkbox" name="permissions[]"
                                                                            value="{{ $key }}"
                                                                            class="form-check-input isscheck crm_checkall isscheck_{{ str_replace(' ', '', $module) }}"
                                                                            id="permission{{ $key }}">
                                                                        <label for="permission{{ $key }}"
                                                                            class="custom-control-label">View</label><br>
                                                                    </div>
                                                            ...
                                                            @if (in_array('view ' . $module, (array) $permissions))
                                                                @if ($key = array_search('view ' . $module, $permissions))
                                                                    <div
                                                                        ...
                                                                        <input type="checkbox" name="permissions[]"
                                                                            value="{{ $key }}"
                                                                            class="form-check-input isscheck project_checkall isscheck_{{ str_replace(' ', '', $module) }}"
                                                                            id="permission{{ $key }}">
                                                                        <label for="permission{{ $key }}"
                                                                            class="custom-control-label">View</label><br>
                                                                    </div>
                                                                ...
                                                                @if ($key = array_search('send ' . $module, $permissions))
                                                                    <div
                                                                        ...
                                                                        <label class="custom-control-label"
                                                                            for="permission{{ $key }}">Send</label><br>
                                                                    </div>
                                                                @endif
                                                            @endif
                                                                ...
                                                                @if ($key = array_search('income ' . $module, $permissions))
                                                                    <div
                                                                        ...
                                                                        <input type="checkbox" name="permissions[]"
                                                                            ...
                                                                            id="permission{{ $key }}">
                                                                        <label class="custom-control-label"
                                                                            for="permission{{ $key }}">Income</label><br>
                                                                    </div>
                                                                @endif
                                                            @endif
                                                                ...
                                                                @if ($key = array_search('expense ' . $module, $permissions))
                                                                    <div
                                                                        ...
                                                                        <input type="checkbox" name="permissions[]"
                                                                            ...
                                                                            id="permission{{ $key }}">
                                                                        <label class="custom-control-label"
                                                                            for="permission{{ $key }}">Expense</label><br>
                                                                    </div>
                                                                @endif
                                                            @endif
                                                                ...
                                                                @if ($key = array_search('tax ' . $module, $permissions))
                                                                    <div
                                                                        ...
                                                                        <input type="checkbox" name="permissions[]"
                                                                            ...
                                                                            id="permission{{ $key }}">
                                                                        <label class="custom-control-label"
                                                                            for="permission{{ $key }}">Tax</label><br>
                                                                    </div>
                                                                @endif
                                                            @endif
                                                                ...
                                                                @if ($key = array_search('invoice ' . $module, $permissions))
                                                                    <div
                                                                        ...
                                                                        <input type="checkbox" name="permissions[]"
                                                                            ...
                                                                            id="permission{{ $key }}">
                                                                        <label class="custom-control-label"
                                                                            for="permission{{ $key }}">Invoice</label><br>
                                                                    </div>
                                                                @endif
                                                            @endif
                                                            @if (in_array('bill ' . $module, (array) $permissions))
                                                                @if ($key = array_search('bill ' . $module, $permissions))
                                                                    <div
                                                                        ...
                                                                        <input type="checkbox" name="permissions[]"
                                                                            ...
                                                                            id="permission{{ $key }}">
                                                                        <label class="custom-control-label"
                                                                            for="permission{{ $key }}">Bill</label><br>
                                                                    </div>
                                                                @endif
                                                            @endif
                                                                ...
                                                                @if ($key = array_search('duplicate ' . $module, $permissions))
                                                                    <div
                                                                        ...
                                                                        <input type="checkbox" name="permissions[]"
                                                                            ...
                                                                            id="permission{{ $key }}">
                                                                        <label class="custom-control-label"
                                                                            for="permission{{ $key }}">Duplicate</label><br>
                                                                    </div>
                                                                @endif
                                                            @endif
                                                                ...
                                                                @if ($key = array_search('ledger ' . $module, $permissions))
                                                                    <div
                                                                        ...
                                                                        <input type="checkbox" name="permissions[]"
                                                                            ...
                                                                            id="permission{{ $key }}">
                                                                        <label class="custom-control-label"
                                                                            for="permission{{ $key }}">Ledger</label><br>
                                                                    </div>
                                                                @endif
                                                            @endif
                                                                ...
                                                                @if ($key = array_search('statement ' . $module, $permissions))
                                                                    <div
                                                                        ...
                                                                        <input type="checkbox" name="permissions[]"
                                                                            ...
                                                                            id="permission{{ $key }}">
                                                                        <label class="custom-control-label"
                                                                            for="permission{{ $key }}">Statement</label><br>
                                                                    </div>
                                                                @endif
                                                            @endif
                                                                ...
                                                                @if ($key = array_search('stock ' . $module, $permissions))
                                                                    <div
                                                                        ...
                                                                        <input type="checkbox" name="permissions[]"
                                                                            ...
                                                                            id="permission{{ $key }}">
                                                                        <label class="custom-control-label"
                                                                            for="permission{{ $key }}">Stock</label><br>
                                                                    </div>
                                                                @endif
                                                            @endif
                                                        ...
                                                        <td>
                                                            <div class="row">
                                                                <div class="col-md-3 custom-control custom-checkbox">
                                                                    <input type="checkbox" name="permissions[]"
                                                                        value="{{ $key }}"
                                                                        class="form-check-input isscheck pos_checkall isscheck_createbarcode"
                                                                        id="permission{{ $key }}">
                                                                    <label class="custom-control-label"
                                                                        for="permission{{ $key }}">{{ __('Create Barcode') }}</label><br>
                                                                </div>
                                                            </div>
                                                        </td>
                                                    </tr>
                                ...
                                @if (!empty($permissions))
                                    ...
                                    <table class="table table-striped mb-0" id="dataTable-1">
                                        ...
                                        <tbody>
                                            ...
                                            @foreach ($modules as $module)
                                                <tr>
                                                    <td><input type="checkbox" class="form-check-input ischeck pos_checkall"
                                                            data-id="{{ str_replace(' ', '', $module) }}"></td>
                                                    <td><label class="ischeck pos_checkall"
                                                            data-id="{{ str_replace(' ', '', $module) }}">{{ ucfirst($module) }}</label>
                                                    </td>
                                                            ...
                                                            @if (in_array('view ' . $module, (array) $permissions))
                                                                @if ($key = array_search('view ' . $module, $permissions))
                                                                    <div
                                                                        ...
                                                                        <input type="checkbox" name="permissions[]"
                                                                            value="{{ $key }}"
                                                                            class="form-check-input isscheck pos_checkall isscheck_{{ str_replace(' ', '', $module) }}"
                                                                            id="permission{{ $key }}">
                                                                        <label class="custom-control-label"
                                                                            for="permission{{ $key }}">View</label><br>
                                                                    </div>
                                                                @endif
                                                            @endif
                                                                ...
                                                                @if ($key = array_search('add ' . $module, $permissions))
                                                                    <div
                                                                        ...
                                                                        <input type="checkbox" name="permissions[]"
                                                                            ...
                                                                            id="permission{{ $key }}">
                                                                        <label class="custom-control-label"
                                                                            for="permission{{ $key }}">Add</label><br>
                                                                    </div>
                                                                @endif
                                                            @endif
                                                                ...
                                                                @if ($key = array_search('update ' . $module, $permissions))
                                                                    <div
                                                                        ...
                                                                        <input type="checkbox" name="permissions[]"
                                                                            ...
                                                                            id="permission{{ $key }}">
                                                                        <label class="custom-control-label"
                                                                            for="permission{{ $key }}">Update</label><br>
                                                                    </div>
                                                                @endif
                                                            @endif
                                                                ...
                                                                @if ($key = array_search('show ' . $module, $permissions))
                                                                    <div
                                                                        ...
                                                                        <input type="checkbox" name="permissions[]"
                                                                            ...
                                                                            id="permission{{ $key }}">
                                                                        <label class="custom-control-label"
                                                                            for="permission{{ $key }}">Show</label><br>
                                                                    </div>
                                                                @endif
                                                            @endif
