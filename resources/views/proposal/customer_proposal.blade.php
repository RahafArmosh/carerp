...
<html lang="en">
    ...
    <head>
        ...
        <title>
            {{ Utility::companyData($proposal->created_by, 'title_text') ? Utility::companyData($proposal->created_by, 'title_text') : config('app.name', 'Orbix') }}
            - {{ __('Proposal') }}</title>
            ...
            <div class="row justify-content-between align-items-center mb-3">
                <div class="col-md-12 d-flex align-items-center justify-content-between justify-content-md-end">
                    <div class="all-button-box mx-2">
                        <a href="{{ route('proposal.pdf', [Crypt::encrypt($proposal->id), 'quotation']) }}" target="_blank"
                                        ...
                                        <div class="col">
                                            <small>
                                                ...
                                                @if ($proposal->status == 0)
                                                    <span
                                                        class="badge badge-pill badge-primary">{{ __(\App\Models\Proposal::$statues[$proposal->status]) }}</span>
                                                @elseif($proposal->status == 1)
                                                    <span
                                                        class="badge badge-pill badge-info">{{ __(\App\Models\Proposal::$statues[$proposal->status]) }}</span>
                                                @elseif($proposal->status == 2)
                                                    <span
                                                        class="badge badge-pill badge-success">{{ __(\App\Models\Proposal::$statues[$proposal->status]) }}</span>
                                                @elseif($proposal->status == 3)
                                                    <span
                                                        class="badge badge-pill badge-warning">{{ __(\App\Models\Proposal::$statues[$proposal->status]) }}</span>
                                                @elseif($proposal->status == 4)
                                                    <span
                                                        class="badge badge-pill badge-danger">{{ __(\App\Models\Proposal::$statues[$proposal->status]) }}</span>
                                                @endif
                                            </small>
                                        </div>
                                                ...
                                                <table class="table mb-0 table-striped">
                                                    ...
                                                    <tfoot>
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td class="text-end">
                                                                {{ $user->priceFormat($proposal->getSubTotal()) }}</td>
                                                        </tr>
                                                        <tr>
                                                            <td colspan="6"></td>
                                                            <td class="text-end"><b>{{ __('Discount') }}</b></td>
                                                            <td class="text-end">
                                                                {{ $user->priceFormat($proposal->getTotalDiscount()) }}
                                                            </td>
                                                        </tr>
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td class="blue-text text-end">
                                                                {{ $user->priceFormat($proposal->getTotal()) }}</td>
                                                        </tr>
                                                    </tfoot>
                                                </table>
                                            </div>
