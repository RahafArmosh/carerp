...
<div class="modal-body">
    <div class="table-responsive">
        <form action="{{ route('projects.copy.link', $projectID) }}" method="POST">
            @csrf
            ...
            <div class="modal-footer">
                @can('share project')
                    ...
                    <a href="#"
                        id="{{ route('projects.link', \Illuminate\Support\Facades\Crypt::encrypt($project->id)) }}"
                        class="btn btn-primary" onclick="copyToClipboard(this)">
                        {{ __('Copy Project') }}
                    </a>
                @endcan
