...
@section('action-btn')
    <div class="float-end">
        @can('create interview schedule')
            <a href="#" data-url="{{ route('job.on.board.create', 0) }}" data-bs-toggle="tooltip" title="{{ __('Create') }}"
                data-ajax-popup="true" class="btn btn-sm btn-primary" data-title="{{ __('Create New Job OnBoard') }}">
                                ...
                                @foreach ($jobOnBoards as $job)
                                    <tr>
                                        ...
                                        <td>
                                            ...
                                            @else
                                                <span
                                                    class="badge bg-primary p-2 px-3 rounded">{{ \App\Models\JobOnBoard::$status[$job->status] }}</span>
                                            @endif
                                        </td>
                                        ...
                                        <td>
                                                ...
                                                <div class="action-btn bg-warning ms-2">
                                                    ...
                                                    <form method="GET"
                                                        ...
                                                        <a href="#"
                                                            ...
                                                            onclick="return confirm('You want to confirm convert to invoice. Press Yes to continue or Cancel to go back')"
                                            ...
                                            <div class="action-btn bg-danger ms-2">
                                                <form method="POST" action="{{ route('job.on.board.delete', $job->id) }}"
                                                    ...
                                                    <a href="#"
                                                        ...
                                                        onclick="return confirm('{{ __('Are You Sure?') . '|' . __('This action can not be undone. Do you want to continue?') }}')"
