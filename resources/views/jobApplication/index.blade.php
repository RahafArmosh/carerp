    ...
    <div class="row">
        <div class="col-sm-12">
            <div class="mt-2 " id="multiCollapseExample1">
                <div class="card">
                    <div class="card-body">
                        <form method="GET" action="{{ route('job-application.index') }}" id="applicarion_filter">
                            <div class="row d-flex align-items-center justify-content-end">

                                <div class="col-xl-3 col-lg-3 col-md-6 col-sm-12 col-12 mr-2">
                                    <div class="btn-box">
                                        <label for="start_date" class="form-label">Start Date</label>
                                        <input id="start_date" type="date" class="month-btn form-control"
                                            name="start_date" value="{{ $filter['start_date'] }}">
                                    </div>
                                </div>
                                ...
                                <div class="col-xl-3 col-lg-3 col-md-6 col-sm-12 col-12 mr-2">
                                    <div class="btn-box">
                                        ...
                                        <input id="end_date" type="date" class="month-btn form-control" name="end_date"
                                ...
                                <div class="col-xl-3 col-lg-3 col-md-6 col-sm-12 col-12">
                                    <div class="btn-box">
                                        ...
                                        <select id="job" name="job" class="form-control select">
                                            @foreach ($jobs as $job)
                                                <option value="{{ $job->id }}"
                                                    {{ $filter['job'] == $job->id ? 'selected' : '' }}>{{ $job->name }}
                                                </option>
                                            @endforeach
                                        </select>
                                    </div>
                                                            ...
                                                            @can('show job application')
                                                                <a class="dropdown-item"
                                                                    ...
                                                                    class="dropdown-item"> <i
                                                                        class="ti ti-bookmark"></i>{{ __('View') }}</a>
                                                            @endcan
                                                            @can('delete job application')
                                                                <form method="POST"
                                                                    action="{{ route('job-application.destroy', $application->id) }}"
                                        ...
                                        <div class="card-body">
                                            <div class="d-flex align-items-center justify-content-between">
                                                <ul class="list-inline mb-0 mt-0">
                                                    ...
                                                    <small
                                                        class="text-md">{{ !empty($application->jobs) ? $application->jobs->title : '' }}</small><br>
