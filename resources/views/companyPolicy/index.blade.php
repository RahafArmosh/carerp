    ...
    <div class="float-end">
        @can('create company policy')
            <a href="#" data-url="{{ route('company-policy.create') }}" data-ajax-popup="true"
                data-title="{{ __('Create New Company Policy') }}" data-bs-toggle="tooltip" title="{{ __('Create') }}"
                                            ...
                                            <td>
                                                ...
                                                @can('delete company policy')
                                                    <div class="action-btn bg-danger ms-2">
                                                        <form action="{{ route('company-policy.destroy', $policy->id) }}"
                                                            method="POST" id="delete-form-{{ $policy->id }}">
                                                            @csrf
                                                            @method('DELETE')
                                                            <a href="#!"
                                                                ...
                                                                onclick="confirmDelete('{{ __('Are You Sure?') . '|' . __('This action can not be undone. Do you want to continue?') }}', 'delete-form-{{ $policy->id }}')">
