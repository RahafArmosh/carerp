...
@section('action-btn')
    <div class="float-end">
        @can('create goal tracking')
            <a href="#" data-size="lg" data-url="{{ route('goaltracking.create') }}" data-ajax-popup="true"
                data-bs-toggle="tooltip" title="{{ __('Create') }}" data-title="{{ __('Create New Goal Tracking') }}"
                                            ...
                                            <td>
                                                ...
                                                @can('delete goal tracking')
                                                    <div class="action-btn bg-danger ms-2">
                                                        <form id="delete-form-{{ $goalTracking->id }}"
                                                            action="{{ route('goaltracking.destroy', $goalTracking->id) }}"
                                                            method="POST">
                                                            @csrf
                                                            @method('DELETE')
                                                            <a href="#"
