<form action="{{ route('projects.expenses.update', [$project->id, $expense->id]) }}" method="POST" id="edit_expense" enctype="multipart/form-data">
    @csrf
    @method('PUT')
        ...
        <div class="row">
            ...
            <div class="col-12 col-md-4">
                <div class="form-group">
                    ...
                    <div class="price-input input-group search-form">
                        ...
                        <input type="number" name="amount" id="amount" class="form-control" value="{{ $expense->amount }}" required min="0">
                    </div>
                </div>
            </div>
            <div class="col-12 col-md-4">
            ...
            <div class="col-12 col-md-12">
                <div class="form-group">
                    ...
                    <textarea name="description" id="description" class="form-control" rows="1" data-toggle="autosize">{{ $expense->description }}</textarea>
                </div>
            </div>
            <div class="col-12 col-md-12">
