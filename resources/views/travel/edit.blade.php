        ...
        <div class="row">
            <div class="form-group col-md-12">
                ...
                <select id="employee_id" name="employee_id" class="form-control select" required>
                    @foreach ($employees as $employee)
                        <option value="{{ $employee->id }}" @if ($employee->id == $travel->employee_id) selected @endif>
            ...
            <div class="form-group col-lg-6 col-md-6">
                ...
                <input id="place_of_visit" type="text" class="form-control" name="place_of_visit"
                    value="{{ $travel->place_of_visit }}">
            </div>
            <div class="form-group col-md-12">
                <label for="description" class="form-label">{{ __('Description') }}</label>
                <textarea id="description" class="form-control" name="description" placeholder="{{ __('Enter Description') }}">{{ $travel->description }}</textarea>
            </div>
        </div>
    </div>
