...
@section('action-btn')
    <div class="float-end">
        @can('create travel')
            <a href="#" data-url="{{ route('travel.create') }}" data-size="lg" data-ajax-popup="true"
                data-title="{{ __('Create New Trip') }}" data-bs-toggle="tooltip" title="{{ __('Create') }}"
                                                ...
                                                @can('edit travel')
                                                    <div class="action-btn bg-primary ms-2">
                                                        <a href="#" class="mx-3 btn btn-sm align-items-center"
                                                            ...
                                                            data-ajax-popup="true" data-title="{{ __('Edit Trip') }}"
                                                ...
                                                @can('delete travel')
                                                    <div class="action-btn bg-danger ms-2">
                                                        <form id="delete-form-{{ $travel->id }}"
                                                            action="{{ route('travel.destroy', $travel->id) }}" method="POST">
                                                            @csrf
                                                            @method('DELETE')
                                                            <a href="#"
                                                                ...
                                                                data-confirm-yes="document.getElementById('delete-form-{{ $travel->id }}').submit();">
