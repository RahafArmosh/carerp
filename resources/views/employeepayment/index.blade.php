                                    ...
                                    <tr>
                                        <td class="Id">
                                            @can('show employee profile')
                                                <a href="{{ route('employeepayment.show', \Illuminate\Support\Facades\Crypt::encrypt($employee->id)) }}"
                                        ...
                                        <td>{{ $employee['chart_account_id'] != 0 ? \App\Models\ChartOfAccount::where('id', $employee['chart_account_id'])->first()->name :'-' }}</td>
                                        @if ($employee['balance'])
                                            <td class="font-style">
                                                {{  \Auth::user()->priceFormat($employee['balance'])  }}</td>
                                        @else
                                            <td>-</td>
                                        @endif
