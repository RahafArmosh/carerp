                                                ...
                                                @can('delete branch')
                                                    <div class="action-btn bg-danger ms-2">
                                                        <form action="{{ route('branch.destroy', $branch->id) }}"
                                                            method="POST" id="delete-form-{{ $branch->id }}">
                                                            @csrf
                                                            @method('DELETE')
                                                            <a href="#"
                                                                ...
                                                                onclick="confirmDelete('{{ __('Are You Sure?') . '|' . __('This action can not be undone. Do you want to continue?') }}', 'delete-form-{{ $branch->id }}')">
