...
@section('action-btn')
    <div class="float-end">
        ...
        @endcan
        @canany(['manage bank account','create bank account','edit bank account'])
            <a href="{{ route('bank-account.export') }}" class="btn btn-sm btn-secondary ms-2" data-bs-toggle="tooltip" title="{{ __('Export') }}" target="_blank">
                        ...
                        <table class="table datatable">
                            ...
                            <tbody>
                                ...
                                @php
                                    ...
                                    $totalBalance = $chartAccountId ? App\Models\Utility::getAccountBalanceNew($chartAccountId) : 0;
                                @endphp
                                    <tr class="font-style">
                                        ...
                                        <td title="{{ $account->bank_address }}">
                                            {{ \Illuminate\Support\Str::limit($account->bank_address, 20) }}
                                        </td>
                                                ...
                                                <span>
                                                    ...
                                                    @can('delete bank account')
                                                        <div class="action-btn bg-danger ms-2">
                                                            <form action="{{ route('bank-account.destroy', $account->id) }}"
