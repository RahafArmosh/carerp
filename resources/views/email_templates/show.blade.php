    ...
    <div class="row">
        <div class="col-xl-12">
            <div class="card">
                <div class="card-body ">
                    {{-- <div class="card"> --}}
                    <form method="POST" action="{{ route('email_template.update', $currEmailTempLang->parent_id) }}">
                        @csrf
                        @method('PUT')
                        <div class="row">
                                        ...
                                        <div class="row text-xs">
                                            ...
                                            @elseif($emailTemplate->slug == 'new_client')
                                                <div class="row">
                                                    ...
                                                    <p class="col-4">{{ __('Client Name') }} : <span
                                                            class="pull-right text-primary">{client_name}</span></p>
                                                    <p class="col-4">{{ __('Email') }} : <span
                                                            class="pull-right text-primary">{client_email}</span></p>
                                                    <p class="col-4">{{ __('Password') }} : <span
                                                            class="pull-right text-primary">{client_password}</span></p>
                                                </div>
                                            @elseif($emailTemplate->slug == 'new_support_ticket')
                                                <div class="row">
                                                    ...
                                                    <p class="col-4">{{ __('User Name') }} : <span
                                                            class="pull-right text-primary">{support_name}</span></p>
                                                    <p class="col-4">{{ __('Support Title') }} : <span
                                                            class="pull-right text-primary">{support_title}</span></p>
                                                    <p class="col-4">{{ __('Support Priority') }} : <span
                                                            class="pull-right text-primary">{support_priority}</span></p>
                                                    <p class="col-4">{{ __('Support End Date') }} : <span
                                                            class="pull-right text-primary">{support_end_date}</span></p>
                                                    <p class="col-4">{{ __('Support Description') }} : <span
                                                            class="pull-right text-primary">{support_description}</span></p>
                                                </div>
                                            @elseif($emailTemplate->slug == 'new_contract')
                                                <div class="row">
                                                    ...
                                                    <p class="col-4">{{ __('Contract Description') }} : <span
                                                            class="pull-right text-primary">{contract_description}</span>
                                                    </p>
                                                </div>
                                            @elseif($emailTemplate->slug == 'lead_assigned')
                                                <div class="row">
                                                    ...
                                                    <p class="col-4">{{ __('Lead Subject') }} : <span
                                                            class="pull-right text-primary">{lead_subject}</span></p>
                                                    <p class="col-4">{{ __('Lead Pipeline') }} : <span
                                                            class="pull-right text-primary">{lead_pipeline}</span></p>
                                                    <p class="col-4">{{ __('Lead Stage') }} : <span
                                                            class="pull-right text-primary">{lead_stage}</span></p>
                                                </div>
                                            @elseif($emailTemplate->slug == 'deal_assigned')
                                                <div class="row">
                                                    <p class="col-4">{{ __('Deal Name') }} : <span
                                                            class="pull-right text-primary">{deal_name}</span></p>
                                                    <p class="col-4">{{ __('Deal Pipeline') }} : <span
                                                            class="pull-right text-primary">{deal_pipeline}</span></p>
                                                    <p class="col-4">{{ __('Deal Stage') }} : <span
                                                            class="pull-right text-primary">{deal_stage}</span></p>
                                                    <p class="col-4">{{ __('Deal Status') }} : <span
                                                            class="pull-right text-primary">{deal_status}</span></p>
                                                    <p class="col-4">{{ __('Deal Price') }} : <span
                                                            class="pull-right text-primary">{deal_price}</span></p>
                                                </div>
                                            @elseif($emailTemplate->slug == 'award_sent')
                                                <div class="row">
                                                    ...
                                                    <p class="col-4">{{ __('Award Email') }} : <span
                                                            class="pull-right text-primary">{award_email}</span></p>
                                                </div>
                                            @elseif($emailTemplate->slug == 'customer_invoice_sent')
                                                <div class="row">
                                                    ...
                                                    <p class="col-4">{{ __('Customer Email') }} : <span
                                                            class="pull-right text-primary">{customer_email}</span></p>
                                            ...
                                            @elseif($emailTemplate->slug == 'new_invoice_payment')
                                                <div class="row">
                                                    ...
                                                    <p class="col-4">{{ __('App Url') }} : <span
                                                            class="pull-right text-primary">{app_url}</span></p>
                                                    <p class="col-4">{{ __('Customer Name') }} : <span
                                                            class="pull-right text-primary">{invoice_payment_name}</span>
                                                    </p>
                                                    <p class="col-4">{{ __('Invoice Payment') }} : <span
                                                            class="pull-right text-primary">{invoice_payment}</span></p>
                                                    <p class="col-4">{{ __('Invoice Payment Amount') }} : <span
                                                            class="pull-right text-primary">{invoice_payment_amount}</span>
                                                    </p>
                                                    <p class="col-4">{{ __('Invoice Payment Date') }} : <span
                                                            class="pull-right text-primary">{invoice_payment_date}</span>
                                                    </p>
                                                    <p class="col-4">{{ __('Invoice Payment Method') }} : <span
                                                            class="pull-right text-primary">{invoice_payment_method}</span>
                                                    </p>
                                            ...
                                            @elseif($emailTemplate->slug == 'new_payment_reminder')
                                                <div class="row">
                                                    ...
                                                    <p class="col-4">{{ __('Payment Reminder Name') }} : <span
                                                            class="pull-right text-primary">{payment_reminder_name}</span>
                                                    </p>
                                                    <p class="col-4">{{ __('Invoice Payment Number') }} : <span
                                                            class="pull-right text-primary">{invoice_payment_number}</span>
                                                    </p>
                                                    <p class="col-4">{{ __('Payment Due Amount') }} : <span
                                                            class="pull-right text-primary">{invoice_payment_dueAmount}</span>
                                                    </p>
                                                    <p class="col-4">{{ __('Payment Reminder Date') }} : <span
                                                            class="pull-right text-primary">{payment_reminder_date}</span>
                                                    </p>
                                                </div>
                                            ...
                                            @elseif($emailTemplate->slug == 'bill_resent')
                                                <div class="row">
                                                    ...
                                                    <p class="col-4">{{ __('Vendor Name') }} : <span
                                                            class="pull-right text-primary">{vender_name}</span></p>
                                                    <p class="col-4">{{ __('Vendor Email') }} : <span
                                                            class="pull-right text-primary">{vender_email}</span></p>
                                            ...
                                            @elseif($emailTemplate->slug == 'complaint_resent')
                                                <div class="row">
                                                    ...
                                                    <p class="col-4">{{ __('Complaint Name') }} : <span
                                                            class="pull-right text-primary">{complaint_name}</span></p>
                                                    <p class="col-4">{{ __('Complaint Title') }} : <span
                                                            class="pull-right text-primary">{complaint_title}</span></p>
                                                    <p class="col-4">{{ __('Complaint Against') }} : <span
                                                            class="pull-right text-primary">{complaint_against}</span></p>
                                                    <p class="col-4">{{ __('Complaint Date') }} : <span
                                                            class="pull-right text-primary">{complaint_date}</span></p>
                                                    <p class="col-4">{{ __('Complaint Date') }} : <span
                                                            class="pull-right text-primary">{complaint_description}</span>
                                                    </p>
                                                </div>
                                            @elseif($emailTemplate->slug == 'leave_action_sent')
                                                <div class="row">
                                                    ...
                                                    <p class="col-4">{{ __('Leave Name') }} : <span
                                                            class="pull-right text-primary">{leave_name}</span></p>
                                            ...
                                            @elseif($emailTemplate->slug == 'payslip_sent')
                                                <div class="row">
                                                    ...
                                                    <p class="col-4">{{ __('Payslip Name') }} : <span
                                                            class="pull-right text-primary">{payslip_name}</span></p>
                                                    <p class="col-4">{{ __('Payslip Salary Month ') }} : <span
                                                            class="pull-right text-primary">{payslip_salary_month}</span>
                                                    </p>
                                                    <p class="col-4">{{ __('Payslip Url') }} : <span
                                                            class="pull-right text-primary">{payslip_url}</span></p>
                                                </div>
                                            @elseif($emailTemplate->slug == 'promotion_sent')
                                                <div class="row">
                                                    ...
                                                    <p class="col-4">{{ __('Designation') }} : <span
                                                            class="pull-right text-primary">{promotion_designation}</span>
                                                    </p>
                                            ...
                                            @elseif($emailTemplate->slug == 'resignation_sent')
                                                <div class="row">
                                                    ...
                                                    <p class="col-4">{{ __('Employee Email') }} : <span
                                                            class="pull-right text-primary">{resignation_email}</span></p>
                                                    <p class="col-4">{{ __('Employee Name') }} : <span
                                            ...
                                            @elseif($emailTemplate->slug == 'termination_sent')
                                                <div class="row">
                                                    ...
                                                    <p class="col-4">{{ __('App Url') }} : <span
                                                            class="pull-right text-primary">{app_url}</span></p>
                                                    <p class="col-4">{{ __('Employee Name') }} : <span
                                                            class="pull-right text-primary">{termination_name}</span></p>
                                                    <p class="col-4">{{ __('Employee Email') }} : <span
                                                            class="pull-right text-primary">{termination_email}</span></p>
                                            ...
                                            @elseif($emailTemplate->slug == 'transfer_sent')
                                                <div class="row">
                                                    ...
                                                    <p class="col-4">{{ __('Employee Email') }} : <span
                                                            class="pull-right text-primary">{transfer_email}</span></p>
                                                    ...
                                                    <p class="col-4">{{ __('Transfer Department') }} : <span
                                                            class="pull-right text-primary">{transfer_department}</span>
                                                    </p>
                                                    ...
                                                    <p class="col-4">{{ __('Transfer Desciption') }} : <span
                                                            class="pull-right text-primary">{transfer_description}</span>
                                                    </p>
                                                </div>
                                            @elseif($emailTemplate->slug == 'trip_sent')
                                                <div class="row">
                                                    ...
                                                    <p class="col-4">{{ __('Employee ') }} : <span
                                                            class="pull-right text-primary">{trip_name}</span></p>
                                            ...
                                            @elseif($emailTemplate->slug == 'vender_bill_sent')
                                                <div class="row">
                                                    ...
                                                    <p class="col-4">{{ __('App Url') }} : <span
                                                            class="pull-right text-primary">{app_url}</span></p>
                                                    <p class="col-4">{{ __('Vendor Name') }} : <span
                                                            class="pull-right text-primary">{vender_bill_name}</span></p>
                                                    <p class="col-4">{{ __('Bill Number') }} : <span
                                                            class="pull-right text-primary">{vender_bill_number}</span></p>
                                                    <p class="col-4">{{ __('Bill Url') }} : <span
                                                            class="pull-right text-primary">{vender_bill_url}</span></p>
                                                </div>
                                            @elseif($emailTemplate->slug == 'warning_sent')
                                                <div class="row">
                                                    ...
                                                    <p class="col-4">{{ __('App Url') }} : <span
                                                            class="pull-right text-primary">{app_url}</span></p>
                                                    <p class="col-4">{{ __('Employee Name') }} : <span
                                                            class="pull-right text-primary">{employee_warning_name}</span>
                                                    </p>
                                                    <p class="col-4">{{ __('Subject') }} : <span
                                                            class="pull-right text-primary">{warning_subject}</span></p>
                                                    <p class="col-4">{{ __('Description') }} : <span
                                                            class="pull-right text-primary">{warning_description}</span>
                                                    </p>
                                                </div>
                                            @endif
                            ...
                            <input id="subject" type="text" class="form-control font-style" name="subject"
                                value="{{ old('subject') ?? $currEmailTempLang->subject }}" required>
                        </div>
                        <div class="form-group col-md-6">
                            <label for="from" class="col-form-label text-dark">{{ __('From') }}</label>
                            <input id="from" type="text" class="form-control font-style" name="from"
                                value="{{ old('from') ?? $emailTemplate->from }}" required>
                        </div>
                        <div class="form-group col-12">
                            <label for="content" class="col-form-label text-dark">{{ __('Email Message') }}</label>
                            <textarea id="content" class="summernote-simple form-control" name="content" required>{{ old('content') ?? $currEmailTempLang->content }}</textarea>
                        </div>
