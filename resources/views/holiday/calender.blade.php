                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-xl-3 col-lg-3 col-md-6 col-sm-12 col-12">
                                            <div class="btn-box">
                                                ...
                                                <input type="date" name="start_date" class="month-btn form-control"
                                        ...
                                        <div class="col-xl-3 col-lg-3 col-md-6 col-sm-12 col-12">
                                            <div class="btn-box">
                                                ...
                                                <input type="date" name="end_date" class="month-btn form-control"
                                                            ...
                                                            @can('delete interview schedule')
                                                                <div class="action-btn bg-danger ms-2">
                                                                    <form
                                                                        ...
                                                                        method="post" id="delete-form-{{ $holiday->id }}">
                                                                        @csrf
                                                                        @method('DELETE')
                                                                        <a href="#"
