...
@section('content')
    <div class="col-sm-12 col-lg-12 col-xl-12 col-md-12 mt-4">
        <div class="card">
            <div class="card-body">
                <form method="POST" action="{{ route('payslip.store') }}" id="payslip_form">
                    @csrf
                    <div class="d-flex align-items-center justify-content-end">
                        <div class="col-xl-2 col-lg-3 col-md-6 col-sm-12 col-12 mx-2">
                            <div class="btn-box">
                                <label for="month" class="form-label">{{ __('Select Month') }}</label>
                        ...
                        <div class="col-auto float-end ms-2 mt-4">
                            <button type="submit" class="btn btn-primary" data-bs-toggle="tooltip"
                                title="{{ __('payslip') }}"
                                data-original-title="{{ __('payslip') }}">{{ __('Generate Payslip') }}</button>
                        </div>
                    </div>
                </form>
            </div>
                    ...
                    <div class="col-md-8">
                        <div class="d-flex align-items-center justify-content-end ">
                            ...
                            <div class="col-xl-2 col-lg-3 col-md-6 col-sm-12 col-12 me-2">
                                <div class="btn-box">
                                    <select name="year" class="form-control year_date">
                                        @foreach ($year as $value)
                                            <option value="{{ $value }}">{{ $value }}</option>
                                        @endforeach
                                    </select>
                            ...
                            <div class="col-auto float-end me-2">
                                <form action="{{ route('payslip.export') }}" method="POST" id="payslip_form">
                                    @csrf
