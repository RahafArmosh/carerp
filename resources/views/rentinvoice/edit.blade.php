...
{{-- @dd($invoice) --}}
<div class="row">
    <form action="{{ route('invoice.update', $invoice->id) }}" method="POST" class="w-100">
        @csrf
        @method('PUT')
        <div class="col-12">
                        ...
                        <div class="col-md-6">
                            <div class="form-group" id="customer-box">
                                ...
                                <select name="customer_id" id="customer" class="form-control select" required>
                                    <!-- Your options for the select field go here -->
                                </select>
                            </div>
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-6">
                                    ...
                                    <select name="category_id" id="category_id" class="form-control select" required>
                                        <!-- Add options here dynamically based on your $category variable -->
                                    </select>
                                ...
                                {{-- <div class="col-md-6"> --}}
                                    {{-- <div class="form-check custom-checkbox mt-4"> --}}
                                        {{-- <input class="form-check-input" type="checkbox" name="discount_apply"
                                            id="discount_apply" {{$invoice->discount_apply==1?'checked':''}}> --}}
                                ...
                                <tr>
                                    ...
                                    <td width="25%" class="form-group">
                                        <select name="item" class="form-control item select"
                                            ...
                                            <!-- Options for the select menu will be populated dynamically -->
                                        </select>
                                    </td>
                                    ...
                                    <td>
                                        ...
                                        <div class="form-group price-input input-group search-form">
                                            <input type="text" name="quantity" class="form-control quantity"
                                                required="required" placeholder="Qty" />
                                    ...
                                    <td>
                                        <div class="form-group price-input input-group search-form">
                                            <input type="text" name="discount" class="form-control discount"
                                                required="required" placeholder="Discount" />
