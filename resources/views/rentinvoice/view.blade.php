                                        ...
                                        <table class="table mb-0 table-striped">
                                            ...
                                            @foreach ($iteams as $key => $iteam)
                                                ...
                                                <tr>
                                                    ...
                                                    <td> {{ !empty($product->category) ? $product->category->name . '/' . $product->brand->name . '/' . $product->subBrand->name : '' }}
                                                    </td>
                                                    <td>{{ 1 . ' (' . $productName->unit->name . ')' }}</td>
                                        ...
                                        @can('delete invoice product')
                                            <td>
                                                <div class="action-btn bg-danger ms-2">
                                                    <form
                                                        action="{{ route('invoice.payment.destroy', ['invoice' => $invoice->id, 'payment' => $payment->id]) }}"
                                            ...
                                            <td>
                                                ...
                                                <div class="action-btn bg-danger ms-2">
                                                    <form
                                                        ...
                                                        method="POST" id="delete-form-{{ $bankPayment->id }}">
                                                        @csrf
                                                        @method('DELETE')
                                ...
                                <tr>
                                    ...
                                    <td>
                                        ...
                                        @can('delete credit note')
                                            <div class="action-btn bg-danger ms-2">
                                                <form
                                                    action="{{ route('invoice.delete.credit.note', ['invoice' => $creditNote->invoice, 'creditNote' => $creditNote->id]) }}"
                                                    method="POST" id="delete-form-{{ $creditNote->id }}">
                                                    @csrf
                                                    @method('DELETE')
