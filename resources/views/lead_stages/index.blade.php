                ...
                <div class="card">
                    <div class="card-body">
                                        ...
                                        @foreach ($pipeline['lead_stages'] as $lead_stages)
                                            <li class="d-flex align-items-center justify-content-between list-group-item"
                                                ...
                                                <span class="float-end">
                                                    @can('edit lead stage')
                                                        <div class="action-btn bg-info ms-2"><a href="#"
                                                    ...
                                                    @if (count($pipeline['lead_stages']))
                                                        @can('delete lead stage')
                                                            <div class="action-btn bg-danger ms-2">
                                                                <form method="POST"
                                                                    action="{{ route('lead_stages.destroy', $lead_stages->id) }}"
                                                                    ...
                                                                    <a href="#"
                                                                        ...
                                                                        onclick="event.preventDefault(); document.getElementById('delete-form-{{ $lead_stages->id }}').submit();">
                        ...
                        <p class=" mt-4"><strong>{{ __('Note') }} :
                            </strong><b>{{ __('You can easily change order of lead stage using drag & drop.') }}</b></p>
                    </div>
                </div>
            </div>
        </div>
