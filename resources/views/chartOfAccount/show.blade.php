    ...
    <div class="row">
        <div class="col-sm-12">
            <div class="mt-2 " id="multiCollapseExample1">
                <div class="card">
                    <div class="card-body">
                        <form action="{{ route('chart-of-account.show', $account->id) }}" method="GET"
                            id="report_drilldown">
                            {{--                        @dd($account->name) --}}
                                        ...
                                        <div class="col-xl-3 col-lg-3 col-md-6 col-sm-12 col-12">
                                            <div class="btn-box">
                                                ...
                                                <input type="date" id="start_date" name="start_date"
                                                    class="month-btn form-control" value="{{ $filter['startDateRange'] }}">
                                            </div>
                                        ...
                                        <div class="col-xl-3 col-lg-3 col-md-6 col-sm-12 col-12">
                                            <div class="btn-box">
                                                ...
                                                <input type="date" id="end_date" name="end_date"
                                                    class="month-btn form-control" value="{{ $filter['endDateRange'] }}">
                                            </div>
                            ...
                            <table class="table">
                                ...
                                <tbody>
                                    ...
                                    @foreach ($chartDatas['bill'] as $billProduct)
                                        <tr>
                                            ...
                                            @php
                                                ...
                                                $vendor = \App\Models\Vender::find(
                                                    !empty($bill) ? $bill->vender_id : '',
                                                );
                                            @endphp
                                    ...
                                    @foreach ($chartDatas['billpayment'] as $billPaymentData)
                                        @php
                                            $bill = \App\Models\BillPayment::where(
                                                'bill_id',
