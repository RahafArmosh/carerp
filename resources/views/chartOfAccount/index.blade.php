...
@section('action-btn')
    ...
    <div class="float-end">
        @can('create chart of account')
            <a href="{{ route('chart-of-account.chart_setup') }}" class="btn btn-sm btn-danger" title="{{ __('Opening Balances') }}">
        ...
        <div class="col-md-12">
            <div class="mt-2" id="multiCollapseExample1">
                <div class="card" id="show_filter">
                    <div class="card-body">
                        <form action="{{ route('chart-of-account.index') }}" method="GET" id="report_bill_summary">
                                        ...
                                        <div class="col-xl-3 col-lg-3 col-md-6 col-sm-12 col-12">
                                            <div class="btn-box">
                                                ...
                                                <input type="date" id="start_date" name="start_date"
                                                    class="startDate form-control" value="{{ $filter['startDateRange'] }}">
                                            </div>
                                            ...
                                            <td class="Action">
                                                ...
                                                @can('delete chart of account')
                                                    <div class="action-btn bg-danger ms-2">
                                                        <form action="{{ route('chart-of-account.destroy', $account->id) }}" method="POST" id="delete-form-{{ $account->id }}">
                                                            @csrf
                                                            @method('DELETE')
                                                        <a href="#"
