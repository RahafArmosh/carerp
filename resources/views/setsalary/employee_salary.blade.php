                                    ...
                                    @can('create set salary')
                                        <div class="col text-end">
                                            <a href="#" data-url="{{ route('employee.basic.salary', $employee->id) }}"
                                                ...
                                                data-toggle="tooltip" data-original-title="{{ __('Basic Salary') }}"
                                                    ...
                                                    <tr>
                                                        ...
                                                        @else
                                                            <td>{{ $saturationdeduction->amount }}%
                                                                (${{ $saturationdeduction->tota_allow }})
                                                            </td>
                                                        @endif
                                    ...
                                    @can('create overtime')
                                        <div class="col text-end">
                                            <a href="#" data-url="{{ route('overtimes.create', $employee->id) }}"
                                                data-size="md" data-ajax-popup="true"
                                                data-title="{{ __('Create Overtime') }}" data-toggle="tooltip"
                                                data-original-title="{{ __('Create Overtime') }}"
                                                class="apply-btn btn btn-sm btn-primary">
                                                <i class="ti ti-plus"></i>
                                            </a>
                                        </div>
