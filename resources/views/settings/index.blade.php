    ...
    <div class="row">
        <div class="col-sm-12">
                            ...
                            <div class="col-md-4">
                                <div class="form-group">
                                    ...
                                    <input type="text" name="mail_host" id="mail_host" class="form-control"
                                        ...
                                        value="{{ isset($settings['mail_host']) ? $settings['mail_host'] : '' }}">
                                ...
                                <div class="row">
                                    <div class="col-md-6 form-group">
                                        ...
                                        <input type="text" name="currency"
                                            value="{{ isset($admin_payment_setting['currency']) ? $admin_payment_setting['currency'] : '' }}"
                                    ...
                                    <div class="col-md-6 form-group">
                                        ...
                                        <input type="text" name="currency_symbol"
                                            value="{{ isset($admin_payment_setting['currency_symbol']) ? $admin_payment_setting['currency_symbol'] : '' }}"
                                                                ...
                                                                <div class="col-lg-12">
                                                                    <div class="input-edits">
                                                                        <div class="form-group">
                                                                            ...
                                                                            <textarea name="bank_details" id="bank_details" class="form-control"
                                                    ...
                                                    <div class="accordion-item">
                                                        <h2 class="accordion-header" id="headingOne">
                                                            <button class="accordion-button collapsed" type="button"
                                                                ...
                                                                data-bs-target="#collapseOne13" aria-expanded="false"
                                                                ...
                                                                <div class="col-lg-6">
                                                                    <div class="form-group">
                                                                        ...
                                                                        <input type="text" name="benefit_api_key"
                                                                            id="benefit_api_key"
                                                                            value="{{ isset($admin_payment_setting['benefit_api_key']) ? $admin_payment_setting['benefit_api_key'] : '' }}"
                                                                            class="form-control"
                                                                ...
                                                                <div class="col-lg-6">
                                                                    <div class="form-group">
                                                                        ...
                                                                        <input type="text" name="cashfree_api_key"
                                                                            id="cashfree_api_key"
                                                                            value="{{ isset($admin_payment_setting['cashfree_api_key']) ? $admin_payment_setting['cashfree_api_key'] : '' }}"
                                                                            class="form-control"
                                                                ...
                                                                <div class="col-lg-6">
                                                                    <div class="form-group">
                                                                        ...
                                                                        <input type="text" name="cashfree_secret_key"
                                                                            ...
                                                                            value="{{ isset($admin_payment_setting['cashfree_secret_key']) ? $admin_payment_setting['cashfree_secret_key'] : '' }}"
                                                                            class="form-control"
                                                                ...
                                                                <div class="col-md-6">
                                                                    <div class="form-group">
                                                                        ...
                                                                        <input type="text" name="aamarpay_store_id"
                                                                            ...
                                                                            value="{{ isset($admin_payment_setting['aamarpay_store_id']) ? $admin_payment_setting['aamarpay_store_id'] : '' }}"
                                                                            class="form-control"
                                                                ...
                                                                <div class="col-md-6">
                                                                    <div class="form-group">
                                                                        ...
                                                                        <input type="text"
                                                                            ...
                                                                            value="{{ isset($admin_payment_setting['aamarpay_signature_key']) ? $admin_payment_setting['aamarpay_signature_key'] : '' }}"
                                                                            class="form-control"
                                                                ...
                                                                <div class="col-md-6">
                                                                    <div class="form-group">
                                                                        ...
                                                                        <input type="text"
                                                                            ...
                                                                            value="{{ isset($admin_payment_setting['aamarpay_description']) ? $admin_payment_setting['aamarpay_description'] : '' }}"
                                                                            class="form-control"
                                                                ...
                                                                <div class="col-md-4">
                                                                    <div class="form-group">
                                                                        ...
                                                                        <input type="text" name="paytr_merchant_id"
                                                                            ...
                                                                            value="{{ isset($admin_payment_setting['paytr_merchant_id']) ? $admin_payment_setting['paytr_merchant_id'] : '' }}"
                                                                            class="form-control"
                                                                            placeholder="{{ __('Merchant Id') }}">
                                                                        <br>
                                                                ...
                                                                <div class="col-md-4">
                                                                    <div class="form-group">
                                                                        ...
                                                                        <input type="text" name="paytr_merchant_key"
                                                                            ...
                                                                            value="{{ isset($admin_payment_setting['paytr_merchant_key']) ? $admin_payment_setting['paytr_merchant_key'] : '' }}"
                                                                            class="form-control"
                                                                            placeholder="{{ __('Merchant Key') }}">
                                                                        <br>
                                                                ...
                                                                <div class="col-md-4">
                                                                    <div class="form-group">
                                                                        <label for="paytr_merchant_salt"
                                                                            class="form-label">{{ __('Merchant Salt') }}</label>
                                                                        <input type="text" name="paytr_merchant_salt"
                                                                            id="paytr_merchant_salt"
                                                                            value="{{ isset($admin_payment_setting['paytr_merchant_salt']) ? $admin_payment_setting['paytr_merchant_salt'] : '' }}"
                                                                            class="form-control"
                                                                ...
                                                                <div class="col-md-6">
                                                                    <div class="form-group">
                                                                        ...
                                                                        <input type="text" name="yookassa_shop_id"
                                                                            id="yookassa_shop_id"
                                                                            value="{{ isset($admin_payment_setting['yookassa_shop_id']) ? $admin_payment_setting['yookassa_shop_id'] : '' }}"
                                                                            class="form-control"
                                                                            placeholder="{{ __('Merchant Id') }}">
                                                                        <br>
                                                                ...
                                                                <div class="col-md-6">
                                                                    <div class="form-group">
                                                                        ...
                                                                        <input type="text" name="yookassa_secret"
                                                                            id="yookassa_secret"
                                                                            value="{{ isset($admin_payment_setting['yookassa_secret']) ? $admin_payment_setting['yookassa_secret'] : '' }}"
                                                                            class="form-control"
                                                                            placeholder="{{ __('Merchant Key') }}">
                                                                        <br>
                                                                ...
                                                                <div class="col-md-6">
                                                                    <div class="form-group">
                                                                        ...
                                                                        <input type="text" name="midtrans_secret"
                                                                            id="midtrans_secret"
                                                                            value="{{ isset($admin_payment_setting['midtrans_secret']) ? $admin_payment_setting['midtrans_secret'] : '' }}"
                                                                            class="form-control"
                                                                            placeholder="{{ __('Merchant Id') }}">
                                                                        <br>
                                                                ...
                                                                <div class="col-md-6">
                                                                    <div class="form-group">
                                                                        ...
                                                                        <input type="text" name="xendit_api"
                                                                            id="xendit_api"
                                                                            value="{{ isset($admin_payment_setting['xendit_api']) ? $admin_payment_setting['xendit_api'] : '' }}"
                                                                            class="form-control"
                                                                ...
                                                                <div class="col-md-6">
                                                                    <div class="form-group">
                                                                        ...
                                                                        <input type="text" name="xendit_token"
                                                                            id="xendit_token"
                                                                            value="{{ isset($admin_payment_setting['xendit_token']) ? $admin_payment_setting['xendit_token'] : '' }}"
                                                                            class="form-control"
            ...
            <div id="pusher-settings" class="card">
                ...
                <form action="{{ route('pusher.setting') }}" method="POST">
                    @csrf
                    <div class="card-body">
                        <div class="row">
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input type="text" name="pusher_app_id" id="pusher_app_id"
                                        value="{{ old('pusher_app_id') }}" class="form-control font-style">
                                    @error('pusher_app_id')
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input type="text" name="pusher_app_key" id="pusher_app_key"
                                        value="{{ old('pusher_app_key') }}" class="form-control font-style">
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input type="text" name="pusher_app_secret" id="pusher_app_secret"
                                        value="{{ old('pusher_app_secret') }}" class="form-control font-style">
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input type="text" name="pusher_app_cluster" id="pusher_app_cluster"
                                        value="{{ old('pusher_app_cluster') }}" class="form-control font-style">
                ...
                <form action="{{ route('seo.settings.store') }}" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="card-body">
                        <div class="row">
                            <div class="col-md-6">
                                <div class="form-group">
                                    <label for="meta_title" class="col-form-label">{{ __('Meta Keywords') }}</label>
                                    <input type="text" name="meta_title" id="meta_title"
                                        value="{{ !empty($setting['meta_title']) ? $setting['meta_title'] : '' }}"
                                        class="form-control" placeholder="{{ __('Meta Keywords') }}">
                                </div>
                                <div class="form-group">
                                    <label for="meta_desc" class="col-form-label">{{ __('Meta Description') }}</label>
                                    <textarea name="meta_desc" id="meta_desc" class="form-control" placeholder="{{ __('Meta Description') }}"
                                        rows="7">{{ !empty($setting['meta_desc']) ? $setting['meta_desc'] : '' }}</textarea>
                                </div>
                        ...
                        <div class="row ">
                            <div class="col-md-6">
                                ...
                                <div class="form-group">
                                    ...
                                    <textarea name="cookie_description" id="cookie_description" class="form-control cookie_setting" rows="3"></textarea>
                                </div>
                            ...
                            <div class="col-md-6">
                                ...
                                <div class="form-group">
                                    ...
                                    <textarea name="strictly_cookie_description" id="strictly_cookie_description" class="form-control cookie_setting"
                                        rows="3"></textarea>
                                </div>
                            </div>
                            <div class="col-12">
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input type="text" name="more_information_description"
                                        id="more_information_description" class="form-control cookie_setting">
                                </div>
                            </div>
                            <div class="col-md-6">
                                <div class="form-group">
                        ...
                        <div class="row">
                            <div class="col-12 form-group">
                                <label for="current_cache_size"
                                    class="col-form-label">{{ __('Current cache size') }}</label>
            ...
            <div id="chat-gpt-settings" class="card">
                ...
                <form action="{{ route('chatgpt.settings') }}" method="POST">
                    @csrf
                    <div class="card-body">
                        <div class="row">
                            <div class="form-group col-md-12">
                                <input type="text" name="chat_gpt_key"
                                    value="{{ isset($settings['chat_gpt_key']) ? $settings['chat_gpt_key'] : '' }}"
                                    class="form-control" placeholder="{{ __('Enter Chat GPT API Key') }}">
