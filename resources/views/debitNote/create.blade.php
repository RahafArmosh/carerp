    ...
    <div class="modal-body">
        <div class="row">
            ...
            <div class="form-group col-md-6">
                ...
                <select id="account_id" name="account_id" class="form-control select select2" required>
            ...
            <div class="form-group col-md-6" id="amount_currency_group">
                ...
                <div class="input-group">
                    <input type="number" step="0.01" min="0" id="amount_in_currency" name="amount_in_currency" class="form-control">
