    ...
    <div class="float-end">
        @can('create appraisal')
            <a href="#" data-size="lg" data-url="{{ route('appraisal.create') }}" data-ajax-popup="true"
                data-bs-toggle="tooltip" title="{{ __('Create') }}" data-title="{{ __('Create New Appraisal') }}"
                                            ...
                                            <td>
                                                ...
                                                @can('delete appraisal')
                                                    <div class="action-btn bg-danger ms-2">
                                                        <form action="{{ route('appraisal.destroy', $appraisal->id) }}"
                                                            method="POST" id="delete-form-{{ $appraisal->id }}">
                                                            @csrf
                                                            @method('DELETE')
                                                            <a href="#"
                                                                ...
                                                                onclick="confirmDelete('{{ __('Are You Sure?') . '|' . __('This action can not be undone. Do you want to continue?') }}', 'delete-form-{{ $appraisal->id }}')">
