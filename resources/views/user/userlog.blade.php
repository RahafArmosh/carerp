                                            ...
                                            <div class="btn-box">
                                                ...
                                                <select name="users" id="users" class="form-control select">
                                                    @foreach ($filteruser as $user)
                                                        <option value="{{ $user }}"
                                                            {{ isset($_GET['users']) && $_GET['users'] == $user ? 'selected' : '' }}>
                                                            {{ $user }}</option>
                                                    @endforeach
                                                </select>
                                            </div>
                                ...
                                <tbody>
                                    @foreach ($userdetails as $user)
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <span
                                                    class="me-5 badge p-2 px-3 rounded bg-primary status_badge">{{ $user->user_type }}</span>
                                            </td>
                                            ...
                                            <td>
                                                ...
                                                @can('delete user')
                                                    <div class="action-btn bg-danger ms-2">
                                                        <form action="{{ route('user.userlogdestroy', $user->user_id) }}"
