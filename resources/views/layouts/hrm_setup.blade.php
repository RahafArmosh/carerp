<div class="card sticky-top" style="top:30px">
    <div class="list-group list-group-flush" id="useradd-sidenav">
        ...
        <a href="{{ route('task-master.index') }}" class="list-group-item list-group-item-action border-0 {{ (request()->is('task-master*') ? 'active' : '')}}">{{__('Task Master')}}<div class="float-end"><i class="ti ti-chevron-right"></i></div></a>
        @endcan
