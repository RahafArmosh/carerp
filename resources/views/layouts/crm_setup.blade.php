<div class="card sticky-top" style="top:30px">
    <div class="list-group list-group-flush" id="useradd-sidenav">
        ...
        <a href="{{ route('lead_roles.index') }}" class="list-group-item list-group-item-action border-0 {{ (Request::route()->getName() == 'lead_roles.index' ) ? 'active' : '' }}   ">{{__('Lead Roles')}}<div class="float-end"><i class="ti ti-chevron-right"></i></div></a>

        <a href="{{ route('campaigns.index') }}" class="list-group-item list-group-item-action border-0 {{ (Request::route()->getName() == 'campaigns.index' ) ? 'active' : '' }}   ">{{__('Campaigns')}}<div class="float-end"><i class="ti ti-chevron-right"></i></div></a>
    </div>
</div>
