...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}" dir="{{$SITE_RTL == 'on' ? 'rtl' : '' }}"
    data-theme="{{ (($setting['cust_darklayout'] ?? '') == 'on') ? 'dark' : 'light' }}">


<meta name="csrf-token" id="csrf-token" content="{{ csrf_token() }}">

<head>
    <title>{{($setting['title_text']) ? $setting['title_text'] : config('app.name', 'AutoCore')}} - @yield('page-title')
    </title>
...
<body class="{{ $color }} motor-deal-shell">
    ...
    <div class="dash-container">
        <div class="dash-content">
            @include('partials.deal_reminder_bar')
