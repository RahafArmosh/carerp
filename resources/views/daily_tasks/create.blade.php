...
@section('content')
    <div class="row">
        <div class="col-xl-12">
            <div class="card">
                <div class="card-body">
                    <form method="post" action="{{ route('daily-tasks.store') }}" id="daily-task-form">
                        @csrf
                        @if ($isCompanyAdmin)
                            <div class="row mb-3">
                                <div class="col-md-6">
                                    ...
                                    <select name="employee_id" id="employee_id_select" class="form-control" required>
                                        ...
                                        @foreach ($employees as $eid => $ename)
                                            <option value="{{ $eid }}"
                                                {{ (string) old('employee_id', $targetEmployee->id) === (string) $eid ? 'selected' : '' }}>
                                                {{ $ename }}</option>
                                        @endforeach
                                    </select>
                                </div>
                        ...
                        <div class="float-end">
                            <a href="{{ route('daily-tasks.index') }}" class="btn btn-light">{{ __('Cancel') }}</a>
