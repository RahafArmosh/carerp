...
@section('action-btn')
    <div class="float-end">
        @can('create coupon')
            <a href="#" data-size="lg" data-url="{{ route('coupons.create') }}" data-ajax-popup="true" data-bs-toggle="tooltip"
                                                    ...
                                                    <div class="action-btn bg-danger ms-2">
                                                        <form action="{{ route('coupons.destroy', $coupon->id) }}"
                                                            ...
                                                            <a href="#!"
                                                                ...
                                                                onclick="confirmDelete('{{ __('Are You Sure?') }}', 'delete-form-{{ $coupon->id }}')">
