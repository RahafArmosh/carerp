...
@section('action-btn')
    <div class="float-end">
        @can('create indicator')
            <a href="#" data-size="lg" data-url="{{ route('indicator.create') }}" data-ajax-popup="true"
                data-bs-toggle="tooltip" title="{{ __('Create') }}" data-title="{{ __('Create New Indicator') }}"
                                                ...
                                                @can('delete indicator')
                                                    <div class="action-btn bg-danger ms-2">
                                                        <form id="delete-form-{{ $indicator->id }}"
                                                            action="{{ route('indicator.destroy', $indicator->id) }}"
                                                            method="POST">
                                                            @csrf
                                                            @method('DELETE')
                                                            <a href="#"
