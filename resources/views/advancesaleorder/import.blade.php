...
@section('page-title')
    {{ __('Import Advance Sale Order (Items only)') }}
@endsection
@section('breadcrumb')
                    ...
                    <form method="post" action="{{ route('advance-saleorder.import') }}" enctype="multipart/form-data">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-12 mb-3">
                                <label for="file" class="form-label">{{ __('Download sample Advance Sale Order items-only file') }}</label>
                                <a href="{{ route('advance-saleorder.sample.items-only') }}" class="btn btn-sm btn-primary" target="_blank">
