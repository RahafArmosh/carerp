                                        ...
                                        <td>
                                            ...
                                            @can('delete loan option')
                                                <div class="action-btn bg-danger ms-2">
                                                    <form action="{{ route('loanoption.destroy', $loanoption->id) }}"
                                                        method="POST" id="delete-form-{{ $loanoption->id }}">
                                                        @csrf
                                                        @method('DELETE')
                                                        ...
                                                        <a href="#"
                                                            ...
                                                            onclick="event.preventDefault(); document.getElementById('delete-form-{{ $loanoption->id }}').submit();">
