                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <img alt="Image placeholder" src="{{ asset('assets/images/gallery.png') }}"
                                                class="avatar view-images rounded-circle avatar-sm" data-bs-toggle="tooltip"
                                            ...
                                            <div class="action-btn bg-danger ms-2">
                                                <form id="delete-form-{{ $trecker->id }}"
                                                    action="{{ route('tracker.destroy', $trecker->id) }}" method="POST">
                                                    @csrf
                                                    @method('DELETE')
                                                    <a href="#"
