...
@section('action-btn')
    <div class="float-end">
        @can('create custom question')
            <a href="#" data-size="lg" data-url="{{ route('custom-question.create') }}" data-ajax-popup="true"
                data-bs-toggle="tooltip" title="{{ __('Create') }}" data-title="{{ __('Create New Custom Question') }}"
                                        ...
                                        <td>
                                            ...
                                            @can('delete custom question')
                                                <div class="action-btn bg-danger ms-2">
                                                    <form action="{{ route('custom-question.destroy', $question->id) }}"
                                                        ...
                                                        <a href="#!"
                                                            ...
                                                            onclick="confirmDelete('{{ __('Are You Sure?') }}', 'delete-form-{{ $question->id }}')">
