                            ...
                            <tbody>
                                @foreach ($venders as $k => $Vender)
                                    <tr class="cust_tr" id="vend_detail">
                                        ...
                                        <td>{{ $Vender['name'] }}</td>
                                        <td>{{ $Vender['supplier_code'] ?? '-' }}</td>
                                        <td>{{ $Vender['contact'] }}</td>
                                        <td>{{ $Vender['email'] }}</td>
                                        <td>{{ $Vender['chart_account_id'] != 0 ? (\App\Models\ChartOfAccount::where('id', $Vender['chart_account_id'])->first()?->name ?? '-') : '-' }}</td>
                                        <td>{{ \Auth::user()->priceFormat($ledgerBalances[$Vender['id']] ?? 0) }}</td>
                                        <td class="Action">
                                            <span>
