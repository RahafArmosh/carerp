                                            ...
                                            <tbody>
                                                @forelse($bankAccountDetail as $bankAccount)
                                                    <tr class="font-style">
                                                        ...
                                                        <td>{{ \Auth::user()->priceFormat($bankAccount->calculated_balance) }}
                                                        </td>
                                                    </tr>
                                                @empty
                                                    <tr>
                                            ...
                                            <tbody>
                                                @forelse($recentInvoice as $invoice)
                                                    <tr>
                                                        ...
                                                        <td>{{ !empty($invoice->customer_name) ? $invoice->customer_name : '' }}
                                                        </td>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td>
                                                            @php
                                                                ...
                                                                $status = $bill->status;
                                                                $statusLabel =
                                                                    \App\Models\Bill::$statues[$status] ?? '-';
                                                                $statusColor =
                                                                    $statusColors[$status] ?? 'bg-light text-dark';
                                                            @endphp
                                                            <span
                                                                class="p-2 px-3 rounded badge {{ $statusColor }}">{{ __($statusLabel) }}</span>
                                                        </td>
                                                    </tr>
                                                @empty
                                                    <tr>
                            ...
                            <div class="card">
                                <div class="card-body">
                                    ...
                                    <div class="tab-content" id="pills-tabContent">
                                        <div class="tab-pane fade show active" id="invoice_weekly_statistics"
                            ...
                            <div class="card">
                                <div class="card-body">
                                    ...
                                    <ul class="nav nav-pills mb-5" id="pills-tab" role="tablist">
                                        ...
                                        <li class="nav-item">
                                            <a class="nav-link" id="pills-profile-tab" data-bs-toggle="pill"
                                                href="#bills_monthly_statistics" role="tab"
                                                aria-controls="pills-profile"
                                                aria-selected="false">{{ __('Bills Monthly Statistics') }}</a>
                                        </li>
                                    </ul>
                                    <div class="tab-content" id="pills-tabContent">
                                        <div class="tab-pane fade show active" id="bills_weekly_statistics"
                                            role="tabpanel" aria-labelledby="pills-home-tab">
                                            <div class="table-responsive">
                                                <table class="table align-items-center mb-0 ">
                                                    <tbody class="list">
                                                ...
                                                <span>
                                                    <span class="row align-items-center">
                                                        ...
                                                        <span class="col">
                                                            ...
                                                            <h6
                                                                class="mb-3 mb-sm-0>{{ \Auth::user()->priceFormat($total) . ' of ' . \Auth::user()->priceFormat($goal->amount) }}</h6>
                                                        </span>
                                                        <span class="col">
                                                                <span
                                                                    class="text-muted text-sm">{{ __('Progress') }}</span>
