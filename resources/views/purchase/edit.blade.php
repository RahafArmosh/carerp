...
@section('content')
    <div class="row">
        ...
        <form action="{{ route('purchase.update', $purchase->id) }}" method="post" class="w-100">
            @csrf
            @method('PUT')
            <div class="col-12">
                            ...
                            <div class="col-md-6">
                                <div class="form-group" id="vender-box">
                                    ...
                                    <select name="vender_id" class="form-control select" id="vender"
                                        data-url="{{ route('purchase.vender') }}" required>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control" value="{{ $purchase_number }}"
                                                readonly>
                                        </div>
                                    </div>
