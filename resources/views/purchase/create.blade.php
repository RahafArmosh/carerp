...
@section('content')
    <div class="row">
        <form  action="{{ url('purchase') }}" method="POST" class="w-100">
            @csrf
        <div class="col-12">
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <select name="warehouse_id" class="form-control select" required>
                                            @foreach ($warehouse as $id => $warehouse)
                ...
                <div class="card-body table-border-style">
                    <div class="table-responsive">
                        <table class="table mb-0" data-repeater-list="items" id="sortable-table">
                            ...
                            <tr>
                                <td width="25%" class="form-group pt-1">
                                    <select name="item" class="form-control select2 item"
                                                data-url="{{ route('purchase.product') }}" required>
                            ...
                            <tr>
                                <td colspan="2">
                                    <div class="form-group"><textarea name="description" class="form-control pro_description" rows="2"
                                        placeholder="{{ __('Description') }}"></textarea></div>
                                </td>
                                <td colspan="5"></td>
                            </tr>
                            </tbody>
