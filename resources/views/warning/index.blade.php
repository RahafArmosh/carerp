...
@section('action-btn')
    <div class="float-end">
        @can('create warning')
            <a href="#" data-url="{{ route('warning.create') }}" data-size="lg" data-ajax-popup="true"
                data-title="{{ __('Create New Warning') }}" data-bs-toggle="tooltip" title="{{ __('Create') }}"
                                            ...
                                            <td>
                                                ...
                                                @can('edit warning')
                                                    <div class="action-btn bg-primary ms-2">
                                                        <a href="#" class="mx-3 btn btn-sm align-items-center"
                                                            ...
                                                            data-ajax-popup="true" data-title="{{ __('Edit Warning') }}"
                                                ...
                                                @can('delete warning')
                                                    <div class="action-btn bg-danger ms-2">
                                                        <form id="delete-form-{{ $warning->id }}"
                                                            action="{{ route('warning.destroy', $warning->id) }}"
                                                            method="POST">
                                                            @csrf
                                                            @method('DELETE')
                                                            <a href="#"
