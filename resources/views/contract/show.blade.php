    ...
    <div class="float-end d-flex align-items-center">
        ...
        @if (\Auth::user()->type == 'company')
            <a href="#" class="btn btn-sm btn-primary btn-icon m-1" data-size="lg"
                ...
                data-title="{{ __('Add signature') }}" class="btn btn-sm btn-primary">
                                                ...
                                                @if ((\Auth::user()->type == 'company' && $contract->status == 'accept') || \Auth::user()->id == $file->user_id)
                                                    <div class="col-auto actions">
                                                        <div class="action-btn bg-danger">
                                                            <form
                                                                action="{{ route('contracts.file.delete', [$contract->id, $file->id]) }}"
                                                                method="post">
                                                                @csrf
                                                                @method('DELETE')
                                        ...
                                        @if ((\Auth::user()->type == 'company' && $contract->status == 'accept') || \Auth::user()->id == $comment->user_id)
                                            <div class="col-auto actions">
                                                <div class="action-btn bg-danger ms-2">
                                                    <form action="{{ route('comment_store.destroy', $comment->id) }}"
                                                        method="post">
                                                        @csrf
                                                        @method('DELETE')
                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        @if (\Auth::user()->type == 'company')
                            <div class="col-12 d-flex">
                                <div class="form-group mb-0 form-send w-100">
                                    <form action="{{ route('note_store.store', $contract->id) }}" method="post">
                                        @csrf
                                ...
                                <div class="list-group-item ">
                                    <div class="row align-items-center">
                                        ...
                                        @if ((\Auth::user()->type == 'company' && $contract->status == 'accept') || \Auth::user()->id == $note->user_id)
                                            <div class="col-auto actions">
                                                <div class="action-btn bg-danger ms-2">
                                                    <form action="{{ route('note_store.destroy', $note->id) }}"
                                                        method="post">
                                                        @csrf
                                                        @method('DELETE')
                                                        ...
                                                        <a href="#!"
                                                            class="mx-3 btn btn-sm align-items-center bs-pass-para"
                                                            onclick="event.preventDefault(); document.getElementById('delete-form-{{ $note->id }}').submit();">
                                                            <i class="ti ti-trash text-white" data-bs-toggle="tooltip"
                                                                data-bs-original-title="{{ __('Delete') }}"></i>
                                                        </a>
                                                    </form>
