                            ...
                            <div class="card-header-right">
                                <div class="btn-group card-option">
                                    ...
                                    <div class="dropdown-menu dropdown-menu-end">
                                        <a href="#!" data-size="md"
                                            data-url="{{ route('contract.edit', $contract->id) }}" data-ajax-popup="true"
                                        ...
                                        <form action="{{ route('contract.destroy', $contract->id) }}" method="POST"
                                            ...
                                            <a href="#!" class="dropdown-item bs-pass-para"
                                                onclick="confirmDelete('{{ __('Are You Sure?') }}', 'delete-form-{{ $contract->id }}')">
                            ...
                            <li class="list-group-item px-0">
                                <div class="row align-items-center">
                                    ...
                                    <div class="col-6 text-end">
                                        <span
                                            class="badge bg-secondary p-2 px-3 rounded">{{ !empty($contract->types) ? $contract->types->name : '' }}</span>
                                    </div>
                                </div>
                            </li>
                            <li class="list-group-item px-0">
                                <div class="row align-items-center">
                                    ...
                                    <div class="col-6 text-end">
                                        <span
                                            class="badge bg-secondary p-2 px-3 rounded">{{ \Auth::user()->priceFormat($contract->value) }}</span>
                                    </div>
                                </div>
                            </li>
