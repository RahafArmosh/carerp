                            ...
                            <tbody>
                                @forelse ($productServices as $productService)
                                    <tr>
                                        ...
                                        <td>
                                            <div id="{{ $productService->id }}" class="product_barcode product_barcode_hight_de" data-skucode="{{ $productService->sku }}">{!! DNS1D::getBarcodeHTML($productService->sku, 'C128') !!}</div>
                                        </td>
                                    </tr>
                                    @empty
                                    <tr>
