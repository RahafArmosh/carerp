...
class CoingatePaymentController extends Controller
{
    ...
    public function paymentConfig()
    {
        ...
        $this->currency            = isset($payment_setting['currency']) ? $payment_setting['currency'] : 'AED';
    ...
    public function companyPaymentConfig()
    {
        ...
        $this->mode                = isset($payment_setting['coingate_mode']) ? $payment_setting['coingate_mode'] : 'off';
        $this->is_enabled          = isset($payment_setting['is_coingate_enabled']) ? $payment_setting['is_coingate_enabled'] : 'off';
        $this->currency            = isset($setting['site_currency']) ? $setting['site_currency'] : 'AED';
...
//        dd($request->all());
    ...
    public function getPaymentStatus(Request $request,$plan)
    {
        ...
        if($plan)
        {
            ...
            $order->price          = $price;
            $order->price_currency = !empty($admin_payment_setting['currency']) ? $admin_payment_setting['currency'] :'AED';
