...
{
    private function canManageCrmAdmin(): bool
    {
        return \Auth::check() && \Auth::user()->can('manage crm admin');
    }

    private function canPipelineAction(string $permission): bool
    {
        return \Auth::check() && (\Auth::user()->can($permission) || $this->canManageCrmAdmin());
    }
    ...
    {
        if($this->canPipelineAction('manage pipeline'))
        {
    ...
    {
        if($this->canPipelineAction('create pipeline'))
        {
    ...
    {
        if($this->canPipelineAction('edit pipeline'))
        {
    ...
    {
        if($this->canPipelineAction('delete pipeline'))
        {
            if($pipeline->created_by == \Auth::user()->creatorId())
            {
