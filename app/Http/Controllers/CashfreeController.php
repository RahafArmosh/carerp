        ...
        if(\Auth::check()){
            ...
            config(
                [
                    ...
                    'services.cashfree.currency' =>!empty($payment_setting['currency']) ? $payment_setting['currency'] : 'AED'
                ]
            );
        }
    }
        ...
        try {
            ...
            if ($respons->order_id && $respons->cf_payment_id != NULL) {
                ...
                if ($info->payment_status == "SUCCESS") {
                    ...
                    $order->price_currency = !empty($payment_setting['currency']) ? $payment_setting['currency'] : 'AED';
