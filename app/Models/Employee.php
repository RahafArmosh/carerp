    ...
    public function get_net_salary()
{
    ...
    {
        return $this->hasMany(EmployeeDailyLog::class, 'employee_id');
    }

    public function customTaskMasters()
    {
        return $this->hasMany(TaskMaster::class, 'created_by_employee_id');
    }
    ...
    public function EmployeeBill($employeeId)
    {
        $bills = Bill:: where('vender_id', $employeeId)->where('user_type','employee')->orderBy('bill_date', 'desc')->get();
