...
class ProductServiceCategory extends Model
{
    ...
    {
        return $this->hasOne('App\Models\ChartOfAccount', 'id', 'sale_account_id');
    }

    public function expenseAccount()
    {
        return $this->hasOne('App\Models\ChartOfAccount', 'id', 'expense_account_id');
    }
    public function purchaseAccount()
    {
        return $this->hasOne('App\Models\ChartOfAccount', 'id', 'purchase_account_id');
    }
    public function brands()
    {
        return $this->belongsToMany(Brand::class, 'brand_category', 'product_service_category_id', 'brand_id')
    ...
    {
        return $this->belongsToMany(CustomField::class, 'custom_field_category', 'product_service_category_id', 'custom_field_id');
    }
}
