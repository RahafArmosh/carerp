...
class Customer extends Authenticatable
{
    ...
    public function customerPos($customerId)
    {
        $invoices  = Pos:: where('customer_id', $customerId)->orderBy('pos_date', 'desc')->get();
    ...
    {
        return $this->hasMany(RentInvoice::class, 'customer_id');
    }
