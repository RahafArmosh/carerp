...
class LeadActivityLog extends Model
{
    ...
    return $this->fetchgetLeadRemark();
}
    ...
    public function fetchgetLeadRemark()
    {
        ...
        if($remark)
        {
            ...
            elseif($this->log_type == 'Convert Lead to deal')
            {
                return $user_name . ' ' . __('Converted this lead to a deal');
            }
            ...
            elseif($this->log_type == 'Update Note')
            {
                return $user_name . ' ' . __('Update Note') . ' <b>' . $remark['note'] . '</b>';
            }
            elseif($this->log_type == 'Add user')
            {
                return $user_name . ' ' . __('Add User') . ' <b>' . $remark['user'] .' to this lead'. '</b>';
            }
             elseif($this->log_type == 'Role matched')
            {
                return  $remark['role'] ;
            }
            elseif($this->log_type == 'Create Lead')
            {
                return $user_name . ' ' . __('Create') . ' <b>' . $remark['create'] . '</b>';
            }
             elseif($this->log_type == 'Remove User')
            {
                return $user_name . ' ' . __('Remove user') . ' <b>' . $remark['user'] . '</b>';
            }
             elseif($this->log_type == 'Update stage')
            {
                return $user_name . ' ' . __('Update stage') . ' <b>' . $remark['stage'] . '</b>';
            }
    ...
    public function logIcon()
    {
        ...
        if(!empty($type))
        {
            ...
            elseif($type == 'Update Note')
            {
                $icon = 'ti-text-wrap';
            }
             elseif($type == 'Add user')
            {
                $icon = 'ti-user';
            }
             elseif($type == 'Role matched')
            {
            ...
            elseif($type == 'Convert Lead to deal')
            {
                $icon = 'ti-exchange';
            }
            elseif($type == 'Create Lead')
            {
             ...
             elseif($type == 'Remove User')
            {
                $icon = 'ti-bell-minus';
            }
            elseif($type == 'Update stage')
            {
                $icon = 'ti-credit-card';
            }
