...
return new class extends Migration
{
    ...
    public function up(): void
    {
        Schema::create('packing_list_items', function (Blueprint $table) {
            ...
            $table->decimal('box_l', 10, 2)->nullable()->comment('Box Length');
            $table->decimal('box_w', 10, 2)->nullable()->comment('Box Width');
            $table->decimal('box_h', 10, 2)->nullable()->comment('Box Height');
            $table->decimal('box_weight', 10, 2)->nullable()->comment('Box Weight');
            $table->timestamps();
            $table->softDeletes();
